 ...
 * 
 *  instance version    {"thr1_0": [[1, 8]], "thr1_1": [[1, 8]], "thr1_2": [[1, 8]], "thr1_3": [[1, 8]], "main": [[1, 6]]}
 *
 *  2021-12-09 13:58:17
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-ext/40_barrier_vf.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {8, 8, 8, 8, 6};
...
IF(0,1,tthr1_0_2)
                                        ...
                                        ;
                                                        ;
                                        static _Bool __dr_nondet_Barrier2_1___cs_tmp_if_cond_0;
tthr1_0_2:
IF(0,2,tthr1_0_3)
                                                        __cs_dataraceActiveVP1 = 2 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 2 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_Barrier2_1___cs_tmp_if_cond_0, "dr_write", 1), ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_Barrier2_1___cs_tmp_if_cond_0, "dr_write_noatomic", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_Barrier2_1___cs_tmp_if_cond_0, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&count, "dr_write"))), __dr_nondet_Barrier2_1___cs_tmp_if_cond_0 = count == 3;
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_Barrier2_1___cs_tmp_if_cond_0, "dr_write"))), __dr_nondet_Barrier2_1___cs_tmp_if_cond_0)
                                                        {
