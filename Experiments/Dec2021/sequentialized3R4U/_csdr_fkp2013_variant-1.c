 ...
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-lit/fkp2013_variant-1.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(5,2,tmain_thread_3)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&n, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&n, "dr_write"))), n = nondet_int();
tmain_thread_3:
IF(5,3,tmain_thread_4)
                                                __cs_dataraceActiveVP2 = 3 == __cs_pc[5];
                                        assume_abort_if_not(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&n, "dr_write"))), n > 0));
tmain_thread_4:
