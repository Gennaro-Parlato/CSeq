 ...
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-wmm/safe023_tso.oepc.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(3,0,tmain_thread_1)
                                        ...
                                        static __cs_t __dr_nondet_main_t2339;
tmain_thread_1:
IF(3,1,tmain_thread_2)
                                        __cs_create(&__dr_nondet_main_t2339, 0, P0_0, 0, 0);
                                        static __cs_t __dr_nondet_main_t2340;
tmain_thread_2:
IF(3,2,tmain_thread_3)
                                        __cs_create(&__dr_nondet_main_t2340, 0, P1_0, 0, 1);
                                        static __cs_t __dr_nondet_main_t2341;
tmain_thread_3:
IF(3,3,tmain_thread_4)
                                        __cs_create(&__dr_nondet_main_t2341, 0, P2_0, 0, 2);
tmain_thread_4:
...
IF(3,7,tmain_thread_8)
                                        ;
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&main$tmp_guard1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&main$tmp_guard1, "dr_write_noatomic"))), ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&y, "dr_write_noatomic"))), (y == 2) && ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__unbuffered_p0_EAX, "dr_write_noatomic")))), ((y == 2) && (__unbuffered_p0_EAX == 1)) && ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__unbuffered_p2_EAX, "dr_write_noatomic")))), (((y == 2) && (__unbuffered_p0_EAX == 1)) && (__unbuffered_p2_EAX == 1)) && ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__unbuffered_p2_EBX, "dr_write_noatomic"))))), main$tmp_guard1 = !((((y == 2) && (__unbuffered_p0_EAX == 1)) && (__unbuffered_p2_EAX == 1)) && (__unbuffered_p2_EBX == 0));
                                        ;
tmain_thread_8:
