 ...
 * 
 *  instance version    {"worker_0": [[1, 2]], "main": [[1, 3]]}
 *
 *  2021-12-09 13:57:05
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-divine/tls_destructor_worker.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[2] __cs_pc[2];
                                        unsigned __CPROVER_bitvector[3] __cs_pc_cs[2];
                                        unsigned __CPROVER_bitvector[1] __cs_last_thread;
                                        unsigned __CPROVER_bitvector[2] __cs_thread_lines[2] = {2, 3};
