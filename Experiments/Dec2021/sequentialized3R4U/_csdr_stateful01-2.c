 ...
 * 
 *  instance version    {"thread1_0": [[1, 6]], "thread2_0": [[1, 6]], "main": [[1, 11]]}
 *
 *  2021-12-09 13:56:25
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread/stateful01-2.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {6, 6, 11};
...
IF(0,0,tthread1_0_1)
                                        ...
                                        __cs_mutex_lock(&ma, 0);
tthread1_0_1:
IF(0,1,tthread1_0_2)
                                                __cs_dataraceActiveVP1 = 1 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 1 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&data1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data1, "dr_write"))), data1++;
tthread1_0_2:
IF(0,2,tthread1_0_3)
                                        __cs_mutex_unlock(&ma, 0);
tthread1_0_3:
IF(0,3,tthread1_0_4)
                                        __cs_mutex_lock(&ma, 0);
tthread1_0_4:
IF(0,4,tthread1_0_5)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&data2, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data2, "dr_write"))), data2++;
tthread1_0_5:
IF(0,5,tthread1_0_6)
                                        __cs_mutex_unlock(&ma, 0);
                                        goto __exit_thread1;
...
IF(1,0,tthread2_0_1)
                                        ...
                                        __cs_mutex_lock(&ma, 1);
tthread2_0_1:
IF(1,1,tthread2_0_2)
                                                __cs_dataraceActiveVP1 = 1 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 1 == __cs_pc[1];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&data1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data1, "dr_write"))), data1 += 5;
tthread2_0_2:
IF(1,2,tthread2_0_3)
                                        __cs_mutex_unlock(&ma, 1);
tthread2_0_3:
IF(1,3,tthread2_0_4)
                                        __cs_mutex_lock(&ma, 1);
tthread2_0_4:
IF(1,4,tthread2_0_5)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&data2, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data2, "dr_write"))), data2 -= 6;
tthread2_0_5:
IF(1,5,tthread2_0_6)
                                        __cs_mutex_unlock(&ma, 1);
                                        goto __exit_thread2;
...
IF(2,3,tmain_thread_4)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&data1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data1, "dr_write"))), data1 = 10;
tmain_thread_4:
IF(2,4,tmain_thread_5)
                                                __cs_dataraceActiveVP1 = 4 == (__cs_pc_cs[2] - 1);
                                        __cs_dataraceActiveVP2 = 4 == __cs_pc[2];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&data2, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data2, "dr_write"))), data2 = 10;
tmain_thread_5:
IF(2,5,tmain_thread_6)
                                        __cs_create(&__dr_nondet_main_t1, 0, thread1_0, 0, 0);
tmain_thread_6:
IF(2,6,tmain_thread_7)
                                        __cs_create(&__dr_nondet_main_t2, 0, thread2_0, 0, 1);
tmain_thread_7:
...
IF(2,9,tmain_thread_10)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_main___cs_tmp_if_cond_0, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_main___cs_tmp_if_cond_0, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data1, "dr_write"))), (data1 != 16) && ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data2, "dr_write")))), __dr_nondet_main___cs_tmp_if_cond_0 = (data1 != 16) && (data2 != 5);
