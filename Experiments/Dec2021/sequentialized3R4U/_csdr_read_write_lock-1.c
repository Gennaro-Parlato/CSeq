 ...
 * 
 *  instance version    {"writer_0": [[1, 3]], "writer_1": [[1, 3]], "reader_0": [[1, 6]], "reader_1": [[1, 6]], "main": [[1, 9]]}
 *
 *  2021-12-09 13:56:32
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-atomic/read_write_lock-1.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {3, 3, 6, 6, 9};
                                        ...
                                        *__cs_cond_to_broadcast = 1;
                                        ...
                                        void __CSEQ_atomic_release_read_lock()
                                        {
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&r, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&r, "dr_write_noatomic"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&r, "dr_write_noatomic"))), r = r - 1;
                                        }
...
treader_0_5:
IF(2,5,treader_0_6)
                                        __CSEQ_atomic_release_read_lock();
                                        goto __exit_reader;
                                                ;
                                        __exit_reader:
