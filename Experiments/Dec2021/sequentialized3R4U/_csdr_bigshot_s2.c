 ...
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread/bigshot_s2.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(2,5,tmain_thread_6)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v[0], "dr_write"))), v[0] == 'B'));
                                        goto __exit_main;
                                                ;
                                        __exit_main:
