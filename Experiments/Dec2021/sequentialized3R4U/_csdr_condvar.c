 ...
 * 
 *  instance version    {"thread_0": [[1, 17]], "main": [[1, 10]]}
 *
 *  2021-12-09 13:56:52
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-divine/condvar.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[2] = {17, 10};
...
IF(0,0,tthread_0_1)
                                        ...
                                        (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_param_thread_arg, "dr_write"))), (void) __dr_param_thread_arg;
tthread_0_1:
IF(0,1,tthread_0_2)
                                        __cs_mutex_lock(&lock, 0);
tthread_0_2:
IF(0,2,tthread_0_3)
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&x_set, "dr_write"))), !(!x_set))
                                                {
                                        goto __exit_loop_1;
                                                        ;
                                                }
...
tthread_0_3:
IF(0,3,tthread_0_4)
                                        __cs_cond_wait_1(&cond, &lock, 0);
tthread_0_4:
IF(0,4,tthread_0_5)
                                        __cs_cond_wait_2(&cond, &lock, 0);
                                        ;
                                                        ;
                                                }
                                        ;
...
IF(0,14,tthread_0_15)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&x_set, "dr_write"))), !(!x_set)));
                                        __exit_loop_1:
...
IF(0,15,tthread_0_16)
                                        ...
                                        (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&x, "dr_write"))), (!(x == 42)) ? (0) : ((void) 0);
tthread_0_16:
...
IF(1,1,tmain_thread_2)
                                        __cs_create(&__dr_nondet_main_t, 0, thread_0, 0, 0);
                                                {
...
IF(1,2,tmain_thread_3)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&x, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&x, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_main_i, "dr_write"))), x = __dr_nondet_main_i;
                                                        }
                                        ;
...
IF(1,6,tmain_thread_7)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_main_i, "dr_write"))), !(__dr_nondet_main_i <= 42)));
                                        __exit_loop_2:
...
IF(1,7,tmain_thread_8)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&x_set, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&x_set, "dr_write"))), x_set = 1;
tmain_thread_8:
