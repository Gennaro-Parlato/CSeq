 ...
 * 
 *  instance version    {"allocator_0": [[1, 10]], "de_allocator_0": [[1, 6]], "main": [[1, 10]]}
 *
 *  2021-12-09 13:56:35
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-atomic/time_var_mutex.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 6, 10};
                                        ...
                                        *__cs_cond_to_broadcast = 1;
                                        ...
                                        __cs_mutex_t m_busy;
                                        void *allocator_0(void *__dr_param_allocator__)
                                        {
IF(0,0,tallocator_0_1)
                                                __cs_dataraceActiveVP1 = 0 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 0 == __cs_pc[0];
                                        __cs_mutex_lock(&m_inode, 0);
                                        ;
                                                ;
                                        static _Bool __dr_nondet_allocator___cs_tmp_if_cond_0;
tallocator_0_1:
IF(0,1,tallocator_0_2)
                                                __cs_dataraceActiveVP1 = 1 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 1 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_allocator___cs_tmp_if_cond_0, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_allocator___cs_tmp_if_cond_0, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&inode, "dr_write"))), __dr_nondet_allocator___cs_tmp_if_cond_0 = inode == 0;
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_allocator___cs_tmp_if_cond_0, "dr_write"))), __dr_nondet_allocator___cs_tmp_if_cond_0)
                                                {
tallocator_0_2:
IF(0,2,tallocator_0_3)
                                        __cs_mutex_lock(&m_busy, 0);
tallocator_0_3:
IF(0,3,tallocator_0_4)
                                                        __cs_dataraceActiveVP1 = 3 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 3 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&busy, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&busy, "dr_write"))), busy = 1;
tallocator_0_4:
IF(0,4,tallocator_0_5)
                                        __cs_mutex_unlock(&m_busy, 0);
tallocator_0_5:
IF(0,5,tallocator_0_6)
                                                        __cs_dataraceActiveVP1 = 5 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 5 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&inode, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&inode, "dr_write"))), inode = 1;
                                                }
                                        __CPROVER_assume(__cs_pc_cs[0] >= 6);
                                                ;
tallocator_0_6:
IF(0,6,tallocator_0_7)
                                                __cs_dataraceActiveVP1 = 6 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 6 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&block, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&block, "dr_write"))), block = 1;
                                        ;
                                                ;
                                        static _Bool __dr_nondet_allocator___cs_tmp_if_cond_1;
tallocator_0_7:
IF(0,7,tallocator_0_8)
                                                __cs_dataraceActiveVP1 = 7 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 7 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_allocator___cs_tmp_if_cond_1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_allocator___cs_tmp_if_cond_1, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&block, "dr_write"))), __dr_nondet_allocator___cs_tmp_if_cond_1 = !(block == 1);
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_allocator___cs_tmp_if_cond_1, "dr_write"))), __dr_nondet_allocator___cs_tmp_if_cond_1)
                                                {
tallocator_0_8:
IF(0,8,tallocator_0_9)
                                        __CPROVER_assume(0);
                                                }
                                        __CPROVER_assume(__cs_pc_cs[0] >= 9);
                                                ;
tallocator_0_9:
IF(0,9,tallocator_0_10)
                                        __cs_mutex_unlock(&m_inode, 0);
...
tallocator_0_10: 
                                        ...
                                        void *de_allocator_0(void *__dr_param_de_allocator__)
                                        {
IF(1,0,tde_allocator_0_1)
                                                __cs_dataraceActiveVP1 = 0 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 0 == __cs_pc[1];
                                        __cs_mutex_lock(&m_busy, 1);
                                        ;
                                                ;
                                        static _Bool __dr_nondet_de_allocator___cs_tmp_if_cond_2;
tde_allocator_0_1:
IF(1,1,tde_allocator_0_2)
                                                __cs_dataraceActiveVP1 = 1 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 1 == __cs_pc[1];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_de_allocator___cs_tmp_if_cond_2, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_de_allocator___cs_tmp_if_cond_2, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&busy, "dr_write"))), __dr_nondet_de_allocator___cs_tmp_if_cond_2 = busy == 0;
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_de_allocator___cs_tmp_if_cond_2, "dr_write"))), __dr_nondet_de_allocator___cs_tmp_if_cond_2)
                                                {
tde_allocator_0_2:
IF(1,2,tde_allocator_0_3)
                                                        __cs_dataraceActiveVP1 = 2 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 2 == __cs_pc[1];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&block, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&block, "dr_write"))), block = 0;
                                        ;
                                                        ;
                                        static _Bool __dr_nondet_de_allocator___cs_tmp_if_cond_3;
tde_allocator_0_3:
IF(1,3,tde_allocator_0_4)
                                                        __cs_dataraceActiveVP1 = 3 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 3 == __cs_pc[1];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_de_allocator___cs_tmp_if_cond_3, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_de_allocator___cs_tmp_if_cond_3, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&block, "dr_write"))), __dr_nondet_de_allocator___cs_tmp_if_cond_3 = !(block == 0);
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_de_allocator___cs_tmp_if_cond_3, "dr_write"))), __dr_nondet_de_allocator___cs_tmp_if_cond_3)
                                                        {
tde_allocator_0_4:
IF(1,4,tde_allocator_0_5)
                                        __CPROVER_assume(0);
                                                        }
                                        ...
                                        __CPROVER_assume(__cs_pc_cs[1] >= 5);
                                                ;
tde_allocator_0_5:
IF(1,5,tde_allocator_0_6)
                                        __cs_mutex_unlock(&m_busy, 1);
...
IF(2,1,tmain_thread_2)
                                        ...
                                        assume_abort_if_not(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&inode, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&busy, "dr_write"))), inode == busy));
tmain_thread_2:
...
IF(2,4,tmain_thread_5)
                                        __cs_create(&__dr_nondet_main_t1, 0, allocator_0, 0, 0);
tmain_thread_5:
IF(2,5,tmain_thread_6)
                                        __cs_create(&__dr_nondet_main_t2, 0, de_allocator_0, 0, 1);
tmain_thread_6:
...
IF(2,8,tmain_thread_9)
                                        __cs_mutex_destroy(&m_inode);
tmain_thread_9:
IF(2,9,tmain_thread_10)
                                        __cs_mutex_destroy(&m_busy);
                                        goto __exit_main;
                                                ;
                                        __exit_main:
...
/* de_allocator_0 */
                                        ...
                                        if (__cs_dr_ts == 2)
                                                                __cs_dataraceDetectionStarted = 1;
                                        de_allocator_0(__cs_threadargs[1]);
