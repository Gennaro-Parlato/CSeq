 ...
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-wmm/safe018_tso.opt.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(3,0,tmain_thread_1)
                                        ...
                                        static __cs_t __dr_nondet_main_t2222;
tmain_thread_1:
IF(3,1,tmain_thread_2)
                                        __cs_create(&__dr_nondet_main_t2222, 0, P0_0, 0, 0);
                                        static __cs_t __dr_nondet_main_t2223;
tmain_thread_2:
IF(3,2,tmain_thread_3)
                                        __cs_create(&__dr_nondet_main_t2223, 0, P1_0, 0, 1);
                                        static __cs_t __dr_nondet_main_t2224;
tmain_thread_3:
IF(3,3,tmain_thread_4)
                                        __cs_create(&__dr_nondet_main_t2224, 0, P2_0, 0, 2);
tmain_thread_4:
