 ...
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-wmm/safe017_tso.oepc.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(3,0,tmain_thread_1)
                                        ...
                                        static __cs_t __dr_nondet_main_t2195;
tmain_thread_1:
IF(3,1,tmain_thread_2)
                                        __cs_create(&__dr_nondet_main_t2195, 0, P0_0, 0, 0);
                                        static __cs_t __dr_nondet_main_t2196;
tmain_thread_2:
IF(3,2,tmain_thread_3)
                                        __cs_create(&__dr_nondet_main_t2196, 0, P1_0, 0, 1);
                                        static __cs_t __dr_nondet_main_t2197;
tmain_thread_3:
IF(3,3,tmain_thread_4)
                                        __cs_create(&__dr_nondet_main_t2197, 0, P2_0, 0, 2);
tmain_thread_4:
