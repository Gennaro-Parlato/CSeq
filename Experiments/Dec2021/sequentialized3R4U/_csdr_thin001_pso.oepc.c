 ...
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-wmm/thin001_pso.oepc.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(3,0,tmain_thread_1)
                                        ...
                                        static __cs_t __dr_nondet_main_t2687;
tmain_thread_1:
IF(3,1,tmain_thread_2)
                                        __cs_create(&__dr_nondet_main_t2687, 0, P0_0, 0, 0);
                                        static __cs_t __dr_nondet_main_t2688;
tmain_thread_2:
IF(3,2,tmain_thread_3)
                                        __cs_create(&__dr_nondet_main_t2688, 0, P1_0, 0, 1);
                                        static __cs_t __dr_nondet_main_t2689;
tmain_thread_3:
IF(3,3,tmain_thread_4)
                                        __cs_create(&__dr_nondet_main_t2689, 0, P2_0, 0, 2);
tmain_thread_4:
