 ...
 * 
 *  instance version    {"thread1_0": [[1, 1]], "thread2_0": [[1, 3]], "main": [[1, 6]]}
 *
 *  2021-12-09 13:56:08
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread/bigshot_s.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {1, 3, 6};
...
IF(0,0,tthread1_0_1)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&v, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v, "dr_write"))), v = __cs_safe_malloc((sizeof(char)) * 8);
                                        goto __exit_thread1;
                                                ;
                                        __exit_thread1:
...
IF(1,0,tthread2_0_1)
                                        ...
                                        ;
                                                ;
                                        static _Bool __dr_nondet_thread2___cs_tmp_if_cond_1;
tthread2_0_1:
IF(1,1,tthread2_0_2)
                                                __cs_dataraceActiveVP1 = 1 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 1 == __cs_pc[1];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_thread2___cs_tmp_if_cond_1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_thread2___cs_tmp_if_cond_1, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v, "dr_write"))), __dr_nondet_thread2___cs_tmp_if_cond_1 = v;
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_thread2___cs_tmp_if_cond_1, "dr_write"))), __dr_nondet_thread2___cs_tmp_if_cond_1)
                                                {
tthread2_0_2:
IF(1,2,tthread2_0_3)
                                                        __cs_dataraceActiveVP2 = 2 == __cs_pc[1];
                                        strcpy(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v, "dr_write"))), v), "Bigshot");
                                                }
...
IF(2,5,tmain_thread_6)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v, "dr_write"))), (!v) || (((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v[0], "dr_write"))))), (!v) || (v[0] == 'B')));
                                        goto __exit_main;
                                                ;
                                        __exit_main:
