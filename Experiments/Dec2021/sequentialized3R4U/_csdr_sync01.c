 ...
 * 
 *  instance version    {"thread1_0": [[1, 17]], "thread2_0": [[1, 17]], "main": [[1, 11]]}
 *
 *  2021-12-09 13:56:25
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread/sync01.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[3] = {17, 17, 11};
...
tthread1_0_1:
IF(0,1,tthread1_0_2)
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&num, "dr_write"))), !(num > 0))
                                                {
                                        goto __exit_loop_1;
                                                        ;
                                                }
...
tthread1_0_2:
IF(0,2,tthread1_0_3)
                                        __cs_cond_wait_1(&empty, &m, 0);
tthread1_0_3:
IF(0,3,tthread1_0_4)
                                        __cs_cond_wait_2(&empty, &m, 0);
                                        ;
                                                        ;
                                                }
                                        ;
...
IF(0,10,tthread1_0_11)
                                        ...
                                        ;
                                                {
tthread1_0_11:
IF(0,11,tthread1_0_12)
                                        __cs_cond_wait_1(&empty, &m, 0);
tthread1_0_12:
IF(0,12,tthread1_0_13)
                                        __cs_cond_wait_2(&empty, &m, 0);
                                        ;
                                                        ;
                                                }
                                        ;
tthread1_0_13:
IF(0,13,tthread1_0_14)
                                                __cs_dataraceActiveVP2 = 13 == __cs_pc[0];
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&num, "dr_write"))), !(num > 0)));
                                        __exit_loop_1:
                                                __CPROVER_assume(__cs_pc_cs[0] >= 14);
                                                ;
                                                ;
tthread1_0_14:
IF(0,14,tthread1_0_15)
                                                __cs_dataraceActiveVP1 = 14 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 14 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&num, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&num, "dr_write"))), num++;
tthread1_0_15:
IF(0,15,tthread1_0_16)
                                        __cs_mutex_unlock(&m, 0);
tthread1_0_16:
IF(0,16,tthread1_0_17)
                                        __cs_cond_signal(&full);
                                        goto __exit_thread1;
                                                ;
                                        __exit_thread1:
...
tthread2_0_2:
IF(1,2,tthread2_0_3)
                                        __cs_cond_wait_1(&full, &m, 1);
tthread2_0_3:
IF(1,3,tthread2_0_4)
                                        __cs_cond_wait_2(&full, &m, 1);
                                        ;
                                                        ;
                                                }
                                        ;
...
IF(1,10,tthread2_0_11)
                                        ...
                                        ;
                                                {
tthread2_0_11:
IF(1,11,tthread2_0_12)
                                        __cs_cond_wait_1(&full, &m, 1);
tthread2_0_12:
IF(1,12,tthread2_0_13)
                                        __cs_cond_wait_2(&full, &m, 1);
                                        ;
                                                        ;
                                                }
...
IF(2,1,tmain_thread_2)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&num, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&num, "dr_write"))), num = 1;
tmain_thread_2:
IF(2,2,tmain_thread_3)
                                        __cs_mutex_init(&m, 0);
tmain_thread_3:
IF(2,3,tmain_thread_4)
                                        __cs_cond_init(&empty, 0);
tmain_thread_4:
IF(2,4,tmain_thread_5)
                                        __cs_cond_init(&full, 0);
tmain_thread_5:
...
IF(2,9,tmain_thread_10)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_main___cs_tmp_if_cond_0, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_main___cs_tmp_if_cond_0, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&num, "dr_write"))), __dr_nondet_main___cs_tmp_if_cond_0 = num != 1;
