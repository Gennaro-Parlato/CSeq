 ...
 * 
 *  instance version    {"thread1_0": [[1, 3]], "thread2_0": [[1, 3]], "thread3_0": [[1, 4]], "main": [[1, 7]]}
 *
 *  2021-12-09 13:56:14
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread/lazy01.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[4] = {3, 3, 4, 7};
...
IF(1,1,tthread2_0_2)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&data, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data, "dr_write"))), data += 2;
tthread2_0_2:
IF(1,2,tthread2_0_3)
