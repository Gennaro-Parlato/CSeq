 ...
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-wmm/safe029_tso.oepc.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(2,0,tmain_thread_1)
                                        ...
                                        static __cs_t __dr_nondet_main_t2485;
tmain_thread_1:
IF(2,1,tmain_thread_2)
                                        __cs_create(&__dr_nondet_main_t2485, 0, P0_0, 0, 0);
                                        static __cs_t __dr_nondet_main_t2486;
tmain_thread_2:
IF(2,2,tmain_thread_3)
                                        __cs_create(&__dr_nondet_main_t2486, 0, P1_0, 0, 1);
tmain_thread_3:
