 ...
 * 
 *  instance version    {"thr1_0": [[1, 1]], "thr2_0": [[1, 2]], "thr2_1": [[1, 2]], "thr2_2": [[1, 2]], "thr2_3": [[1, 2]], "main": [[1, 8]]}
 *
 *  2021-12-09 13:58:30
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread-lit/fkp2013-1.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[6] = {1, 2, 2, 2, 2, 8};
...
IF(0,0,tthr1_0_1)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&x, "dr_write"))), x < 50));
                                        goto __exit_thr1;
                                                ;
                                        __exit_thr1:
...
IF(5,7,tmain_thread_8)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_main_i, "dr_write"))), !(__dr_nondet_main_i < 50)));
                                        __exit_loop_1:
