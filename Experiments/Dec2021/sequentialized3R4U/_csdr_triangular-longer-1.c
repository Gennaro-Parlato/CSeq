 ...
 *
 *  params:
 *    -i /home/salvatore/github/CSeq/svcomp2020-concurrency-benchmarks/pthread/triangular-longer-1.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(0,5,tt1_0_6)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_t1_k, "dr_write"))), !(__dr_nondet_t1_k < 10)));
                                        __exit_loop_1:
...
IF(1,5,tt2_0_6)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_t2_k, "dr_write"))), !(__dr_nondet_t2_k < 10)));
                                        __exit_loop_2:
