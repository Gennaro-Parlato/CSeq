 ...
 * 
 *  instance version    {"thr1_0": [[1, 27]], "thr2_0": [[1, 27]], "main": [[1, 4]]}
 *
 *  2021-07-01 10:16:46
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/dekker.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[3] = {27, 27, 4};
...
IF(1,2,tthr2_0_3)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thr2___cs_tmp_if_cond_2, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thr2___cs_tmp_if_cond_2, "dr_write"))), __cs_nondet_thr2___cs_tmp_if_cond_2 = turn != 1;
