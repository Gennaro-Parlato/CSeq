 ...
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/triangular-longer-1.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(2,2,tmain_thread_3)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_main_condI, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_main_condI, "dr_write_noatomic"))), __cs_nondet_main_condI = i > (20 + 6);
                                        ;
tmain_thread_3:
IF(2,3,tmain_thread_4)
                                        ;
                                        static int __cs_nondet_main_condJ;
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_main_condJ, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_main_condJ, "dr_write_noatomic"))), __cs_nondet_main_condJ = j > (20 + 6);
                                        ;
                                        ;
                                                ;
