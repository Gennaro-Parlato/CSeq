 ...
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/szymanski.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(1,3,tthr2_0_4)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thr2___cs_tmp_if_cond_2, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thr2___cs_tmp_if_cond_2, "dr_write"))), __cs_nondet_thr2___cs_tmp_if_cond_2 = flag1 == 1;
