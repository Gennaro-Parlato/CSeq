 ...
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/time_var_mutex.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
IF(0,1,tallocator_0_2)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_allocator___cs_tmp_if_cond_0, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_allocator___cs_tmp_if_cond_0, "dr_write"))), __cs_nondet_allocator___cs_tmp_if_cond_0 = inode == 0;
...
IF(0,7,tallocator_0_8)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_allocator___cs_tmp_if_cond_1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_allocator___cs_tmp_if_cond_1, "dr_write"))), __cs_nondet_allocator___cs_tmp_if_cond_1 = !(block == 1);
...
IF(1,1,tde_allocator_0_2)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_de_allocator___cs_tmp_if_cond_2, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_de_allocator___cs_tmp_if_cond_2, "dr_write"))), __cs_nondet_de_allocator___cs_tmp_if_cond_2 = busy == 0;
