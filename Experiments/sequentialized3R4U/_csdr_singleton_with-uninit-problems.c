 ...
 * 
 *  instance version    {"thread1_0": [[1, 1]], "thread2_0": [[1, 1]], "thread2_1": [[1, 1]], "thread2_2": [[1, 1]], "thread3_0": [[1, 1]], "thread0_0": [[1, 10]], "main": [[1, 3]]}
 *
 *  2021-07-01 10:16:37
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/singleton_with-uninit-problems.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[7] = {1, 1, 1, 1, 1, 10, 3};
...
IF(1,0,tthread2_0_1)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&v[0], "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v[0], "dr_write"))), v[0] = 'X';
                                        goto __exit_thread2;
                                                ;
                                        __exit_thread2:
...
IF(4,0,tthread3_0_1)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&v[0], "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v[0], "dr_write"))), v[0] = 'Y';
                                        goto __exit_thread3;
                                                ;
                                        __exit_thread3:
...
IF(5,0,tthread0_0_1)
                                        ...
                                        __cs_create(&__cs_nondet_thread0_t1, 0, thread1_0, 0, 0);
tthread0_0_1:
IF(5,1,tthread0_0_2)
                                                __cs_dataraceActiveVP2 = 1 == __cs_pc[5];
                                        __cs_join(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thread0_t1, "dr_write"))), __cs_nondet_thread0_t1), 0);
tthread0_0_2:
IF(5,2,tthread0_0_3)
                                        __cs_create(&__cs_nondet_thread0_t2, 0, thread2_0, 0, 1);
tthread0_0_3:
IF(5,3,tthread0_0_4)
                                        __cs_create(&__cs_nondet_thread0_t3, 0, thread3_0, 0, 4);
tthread0_0_4:
IF(5,4,tthread0_0_5)
                                        __cs_create(&__cs_nondet_thread0_t4, 0, thread2_1, 0, 2);
tthread0_0_5:
IF(5,5,tthread0_0_6)
                                        __cs_create(&__cs_nondet_thread0_t5, 0, thread2_2, 0, 3);
tthread0_0_6:
IF(5,6,tthread0_0_7)
                                                __cs_dataraceActiveVP2 = 6 == __cs_pc[5];
                                        __cs_join(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thread0_t2, "dr_write"))), __cs_nondet_thread0_t2), 0);
tthread0_0_7:
IF(5,7,tthread0_0_8)
                                                __cs_dataraceActiveVP2 = 7 == __cs_pc[5];
                                        __cs_join(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thread0_t3, "dr_write"))), __cs_nondet_thread0_t3), 0);
tthread0_0_8:
IF(5,8,tthread0_0_9)
                                                __cs_dataraceActiveVP2 = 8 == __cs_pc[5];
                                        __cs_join(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thread0_t4, "dr_write"))), __cs_nondet_thread0_t4), 0);
tthread0_0_9:
IF(5,9,tthread0_0_10)
                                                __cs_dataraceActiveVP2 = 9 == __cs_pc[5];
                                        __cs_join(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thread0_t5, "dr_write"))), __cs_nondet_thread0_t5), 0);
                                        goto __exit_thread0;
                                                ;
                                        __exit_thread0:
...
IF(6,0,tmain_thread_1)
                                        ...
                                        __cs_create(&__cs_nondet_main_t, 0, thread0_0, 0, 5);
tmain_thread_1:
IF(6,1,tmain_thread_2)
                                                __cs_dataraceActiveVP2 = 1 == __cs_pc[6];
                                        __cs_join(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_main_t, "dr_write"))), __cs_nondet_main_t), 0);
tmain_thread_2:
