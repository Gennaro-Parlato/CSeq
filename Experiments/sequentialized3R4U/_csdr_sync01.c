 ...
 * 
 *  instance version    {"thread1_0": [[1, 17]], "thread2_0": [[1, 17]], "main": [[1, 6]]}
 *
 *  2021-07-01 10:16:43
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/sync01.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[3] = {17, 17, 6};
...
IF(2,4,tmain_thread_5)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_main___cs_tmp_if_cond_0, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_main___cs_tmp_if_cond_0, "dr_write"))), __cs_nondet_main___cs_tmp_if_cond_0 = num != 1;
