 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/gcd-2.i, --rounds 4, --unwind 4, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {5, 10, 10};
...
tdec_a_0_9:
IF(1,9,tdec_a_0_10)
                                                  if (((9 == __cs_pc[1]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&a, "dr_write") || __CPROVER_get_field(&b, "dr_write")))
...
tdec_b_0_9:
IF(2,9,tdec_b_0_10)
                                                  if (((9 == __cs_pc[2]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&a, "dr_write") || __CPROVER_get_field(&b, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(a != b));
                                                  __exit_loop_2:
