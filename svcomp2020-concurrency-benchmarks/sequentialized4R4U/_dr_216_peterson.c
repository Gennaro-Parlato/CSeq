 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/16_peterson.i, --rounds 4, --unwind 4, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[2] = {14, 10};
...
tthr1_0_6:
IF(1,6,tthr1_0_7)
                                                  if (((6 == __cs_pc[1]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&flag2, "dr_write") || __CPROVER_get_field(&turn, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
...
IF(1,9,tthr1_0_10)
                                                  if (((9 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag1, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  flag1 = 0;
                                                  goto __exit_thr1;
                                                  ;
...
tmain_8:
IF(0,8,tmain_9)
                                                            if (((8 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&flag1, "dr_write") || __CPROVER_get_field(&turn, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
...
IF(0,11,tmain_12)
                                                            if (((11 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag2, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            flag2 = 0;
tmain_12:
IF(0,12,tmain_13)
