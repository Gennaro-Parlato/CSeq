 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/sigma.i, --rounds 4, --unwind 4, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[5] = {30, 1, 1, 1, 1};
...
tmain_10:
IF(0,10,tmain_11)
                                                  if (((10 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
tmain_19:
IF(0,19,tmain_20)
                                                  if (((19 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(__cs_nondet_main_tid < SIGMA));
                                                  __exit_loop_2:
...
tmain_21:
IF(0,21,tmain_22)
                                                            if (((21 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
...
tmain_23:
IF(0,23,tmain_24)
                                                            if (((23 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
...
tmain_25:
IF(0,25,tmain_26)
                                                            if (((25 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
...
tmain_27:
IF(0,27,tmain_28)
                                                            if (((27 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
...
tmain_28:
IF(0,28,tmain_29)
                                                  if (((28 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(__cs_nondet_main_tid < SIGMA));
                                                  __exit_loop_3:
...
tmain_29:
IF(0,29,tmain_30)
                                                  if (((29 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
