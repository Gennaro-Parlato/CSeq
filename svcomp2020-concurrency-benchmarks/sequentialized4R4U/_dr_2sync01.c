 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/sync01.i, --rounds 4, --unwind 4, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[3] = {5, 17, 17};
...
IF(1,13,tthread1_0_14)
                                                  if (((13 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
...
IF(1,14,tthread1_0_15)
                                                  if (((14 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  num++;
tthread1_0_15:
...
IF(2,13,tthread2_0_14)
                                                  if (((13 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(num == 0));
                                                  __exit_loop_2:
...
IF(2,14,tthread2_0_15)
                                                  if (((14 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  num--;
tthread2_0_15:
