 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/mix041_tso.opt.i, --rounds 3, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
