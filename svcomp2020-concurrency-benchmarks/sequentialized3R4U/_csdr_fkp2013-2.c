 ...
 * 
 *  instance version    {"thr1_0": [[1, 1]], "thr2_0": [[1, 2]], "thr2_1": [[1, 2]], "thr2_2": [[1, 2]], "thr2_3": [[1, 2]], "main": [[1, 6]]}
 *
 *  2021-07-01 10:18:50
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-lit/fkp2013-2.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[6] = {1, 2, 2, 2, 2, 6};
...
IF(5,5,tmain_thread_6)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_main_i, "dr_write"))), !(__cs_nondet_main_i < 50)));
                                        __exit_loop_1:
