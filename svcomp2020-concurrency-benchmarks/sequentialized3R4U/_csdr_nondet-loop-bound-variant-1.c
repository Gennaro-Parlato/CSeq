 ...
 * 
 *  instance version    {"thr1_0": [[1, 1]], "thr2_0": [[1, 6]], "thr2_1": [[1, 6]], "thr2_2": [[1, 6]], "thr2_3": [[1, 6]], "main": [[1, 10]]}
 *
 *  2021-07-01 10:18:56
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-nondet/nondet-loop-bound-variant-1.i, --rounds 3, --unwind 4, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[6] = {1, 6, 6, 6, 6, 10};
...
IF(1,2,tthr2_0_3)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thr2_t, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thr2_t, "dr_write"))), __cs_nondet_thr2_t = x;
                                        ;
                                                ;
...
IF(1,3,tthr2_0_4)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thr2___cs_tmp_if_cond_2, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thr2___cs_tmp_if_cond_2, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thr2_k, "dr_write"))), __cs_nondet_thr2___cs_tmp_if_cond_2 = __cs_nondet_thr2_k == n;
...
IF(5,1,tmain_thread_2)
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_main_i, "dr_write"))), !(__cs_nondet_main_i < n))
                                                        {
                                        goto __exit_loop_1;
                                                                ;
                                                        }
...
IF(5,8,tmain_thread_9)
                                        __cs_create(&__cs_nondet_main_t2, 0, thr2_3, 0, 4);
                                                        }
                                        ;
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_main_i, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_main_i, "dr_write"))), __cs_nondet_main_i++;
tmain_thread_9:
IF(5,9,tmain_thread_10)
                                                        __cs_dataraceActiveVP2 = 9 == __cs_pc[5];
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_main_i, "dr_write"))), !(__cs_nondet_main_i < n)));
                                        __exit_loop_1:
