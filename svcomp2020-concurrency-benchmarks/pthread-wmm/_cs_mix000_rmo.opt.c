 ...
 *
 *  params:
 *    -i ../../../ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/mix000_rmo.opt.c, 
 *
 */
...
IF(2,0,tmain_thread_1)
                                        ...
                                        ;
                                                ;
                                        __cs_create(&__cs_local_main_t8, 0, P0_0, 0, 0);
                                        static __cs_t __cs_local_main_t9;
                                        ;
                                                ;
tmain_thread_1:
IF(2,1,tmain_thread_2)
                                        __cs_create(&__cs_local_main_t9, 0, P1_0, 0, 1);
tmain_thread_2:
...
/* main */
                                        ...
                                        __CPROVER_assume(__cs_pc_cs[2] <= $ML2);
                                        main_thread();
...
/* P0_0 */
                                        ...
                                        __CPROVER_assume(__cs_pc_cs[0] <= $ML0);
...
/* P1_0 */
                                        ...
                                        __CPROVER_assume(__cs_pc_cs[1] <= $ML1);
