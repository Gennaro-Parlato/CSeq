 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-divine/tls_destructor_worker.i, --rounds 2, --unwind 3, --local-vars 2, --seq , --debug , 
 *
 */
