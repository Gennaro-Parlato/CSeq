 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/38_rand_cas_vs_concur.i, --rounds 2, --unwind 3, --local-vars 2, --seq , --debug , 
 *
 */
