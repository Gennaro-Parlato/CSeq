 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/14_spin2003.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[6] = {6, 5, 5, 5, 5, 5};
...
tthr1_0_3:
IF(1,3,tthr1_0_4)
                                                            if (((3 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thr1___cs_tmp_if_cond_0 = !(x >= 1);
...
tthr1_1_3:
IF(2,3,tthr1_1_4)
                                                            if (((3 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thr1___cs_tmp_if_cond_0 = !(x >= 1);
                                                            if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                                                {
...
tthr1_2_3:
IF(3,3,tthr1_2_4)
                                                            if (((3 == __cs_pc[3]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thr1___cs_tmp_if_cond_0 = !(x >= 1);
                                                            if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                                                {
...
tthr1_3_3:
IF(4,3,tthr1_3_4)
                                                            if (((3 == __cs_pc[4]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thr1___cs_tmp_if_cond_0 = !(x >= 1);
                                                            if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                                                {
...
tthr1_4_3:
IF(5,3,tthr1_4_4)
                                                            if (((3 == __cs_pc[5]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thr1___cs_tmp_if_cond_0 = !(x >= 1);
                                                            if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                                                {
