 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/peterson.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
tthr1_0_2:
IF(1,2,tthr1_0_3)
                                                  if (((2 == __cs_pc[1]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&flag2, "dr_write") || __CPROVER_get_field(&turn, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
...
tthr1_0_4:
IF(1,4,tthr1_0_5)
                                                  if (((4 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
IF(2,1,tthr2_0_2)
                                                  if (((1 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&turn, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  turn = 0;
tthr2_0_2:
IF(2,2,tthr2_0_3)
                                                  if (((2 == __cs_pc[2]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&flag1, "dr_write") || __CPROVER_get_field(&turn, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
...
IF(2,4,tthr2_0_5)
                                                  if (((4 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_thr2___cs_tmp_if_cond_1 = !(x >= 1);
