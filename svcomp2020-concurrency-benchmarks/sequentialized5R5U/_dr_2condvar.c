 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-divine/condvar.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[2] = {10, 20};
...
IF(1,16,tthread_0_17)
                                                  ...
                                                  ;
tthread_0_17:
IF(1,17,tthread_0_18)
                                                  if (((17 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x_set, "dr_write"))
...
IF(0,5,tmain_6)
                                                                      if (((5 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      x = __cs_nondet_main_i;
                                                            }
                                                            ;
...
IF(0,7,tmain_8)
                                                  if (((7 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x_set, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  x_set = 1;
tmain_8:
IF(0,8,tmain_9)
