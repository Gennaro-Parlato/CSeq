 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-C-DAC/pthread-demo-datarace-1.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[2] = {18, 22};
...
IF(1,0,tthread_function_mutex_0_1)
                                                  __cs_nondet_thread_function_mutex_i = 0;
                                                            {
tthread_function_mutex_0_1:
IF(1,1,tthread_function_mutex_0_2)
                                                            __cs_mutex_lock(&mymutex, 1);
tthread_function_mutex_0_2:
IF(1,2,tthread_function_mutex_0_3)
                                                            if (((2 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thread_function_mutex_j = myglobal;
                                                            __cs_nondet_thread_function_mutex_j = __cs_nondet_thread_function_mutex_j + 1;
...
tthread_function_mutex_0_3:
                                                            ...
                                                            {
                                                                      __CPROVER_set_field(&myglobal, "dr_write", 1);
                                                            }
IF(1,3,tthread_function_mutex_0_4)
                                                            if (((3 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = __cs_nondet_thread_function_mutex_j;
tthread_function_mutex_0_4:
IF(1,4,tthread_function_mutex_0_5)
                                                            __cs_mutex_unlock(&mymutex, 1);
                                                  }
                                                  ;
                                                  __cs_nondet_thread_function_mutex_i++;
                                                            {
tthread_function_mutex_0_5:
IF(1,5,tthread_function_mutex_0_6)
                                                            __cs_mutex_lock(&mymutex, 1);
tthread_function_mutex_0_6:
IF(1,6,tthread_function_mutex_0_7)
                                                            if (((6 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thread_function_mutex_j = myglobal;
                                                            __cs_nondet_thread_function_mutex_j = __cs_nondet_thread_function_mutex_j + 1;
                                                            printf("\nIn thread_function_mutex..\t");
...
IF(1,7,tthread_function_mutex_0_8)
                                                            if (((7 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = __cs_nondet_thread_function_mutex_j;
tthread_function_mutex_0_8:
IF(1,8,tthread_function_mutex_0_9)
                                                            __cs_mutex_unlock(&mymutex, 1);
                                                  }
                                                  ;
                                                  __cs_nondet_thread_function_mutex_i++;
...
IF(1,9,tthread_function_mutex_0_10)
                                                            __cs_mutex_lock(&mymutex, 1);
tthread_function_mutex_0_10:
IF(1,10,tthread_function_mutex_0_11)
                                                            if (((10 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thread_function_mutex_j = myglobal;
                                                            __cs_nondet_thread_function_mutex_j = __cs_nondet_thread_function_mutex_j + 1;
                                                            printf("\nIn thread_function_mutex..\t");
...
IF(1,11,tthread_function_mutex_0_12)
                                                            if (((11 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = __cs_nondet_thread_function_mutex_j;
tthread_function_mutex_0_12:
IF(1,12,tthread_function_mutex_0_13)
                                                            __cs_mutex_unlock(&mymutex, 1);
                                                  }
                                                  ;
                                                  __cs_nondet_thread_function_mutex_i++;
...
IF(1,13,tthread_function_mutex_0_14)
                                                            __cs_mutex_lock(&mymutex, 1);
tthread_function_mutex_0_14:
IF(1,14,tthread_function_mutex_0_15)
                                                            if (((14 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thread_function_mutex_j = myglobal;
                                                            __cs_nondet_thread_function_mutex_j = __cs_nondet_thread_function_mutex_j + 1;
                                                            printf("\nIn thread_function_mutex..\t");
...
IF(1,15,tthread_function_mutex_0_16)
                                                            if (((15 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = __cs_nondet_thread_function_mutex_j;
tthread_function_mutex_0_16:
IF(1,16,tthread_function_mutex_0_17)
                                                            __cs_mutex_unlock(&mymutex, 1);
                                                  }
                                                  ;
                                                  __cs_nondet_thread_function_mutex_i++;
...
IF(1,17,tthread_function_mutex_0_18)
                                                            __cs_mutex_lock(&mymutex, 1);
tthread_function_mutex_0_18:
IF(1,18,tthread_function_mutex_0_19)
                                                            if (((18 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thread_function_mutex_j = myglobal;
                                                            __cs_nondet_thread_function_mutex_j = __cs_nondet_thread_function_mutex_j + 1;
                                                            printf("\nIn thread_function_mutex..\t");
tthread_function_mutex_0_19:
                                                            if (((19 == __cs_pc_cs[1]) & __cs_dataraceDetectionStarted) & (!__cs_dataraceSecondThread))
                                                            {
                                                                      __CPROVER_set_field(&myglobal, "dr_write", 1);
                                                            }
IF(1,19,tthread_function_mutex_0_20)
                                                            if (((19 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = __cs_nondet_thread_function_mutex_j;
tthread_function_mutex_0_20:
IF(1,20,tthread_function_mutex_0_21)
                                                            __cs_mutex_unlock(&mymutex, 1);
                                                  }
                                                  ;
                                                  __cs_nondet_thread_function_mutex_i++;
tthread_function_mutex_0_21:
IF(1,21,tthread_function_mutex_0_22)
                                                  __CPROVER_assume(!(__cs_nondet_thread_function_mutex_i < 20));
                                                  __exit_loop_1:
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_nondet_main___cs_tmp_if_cond_0 = __cs_create(&__cs_nondet_main_mythread, 0, thread_function_mutex_0, 0, 1);
...
IF(0,2,tmain_3)
                                                            if (((2 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&myglobal, "dr_write") || __CPROVER_get_field(&myglobal, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = myglobal + 1;
tmain_3:
IF(0,3,tmain_4)
...
IF(0,5,tmain_6)
                                                            if (((5 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&myglobal, "dr_write") || __CPROVER_get_field(&myglobal, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = myglobal + 1;
tmain_6:
IF(0,6,tmain_7)
...
IF(0,8,tmain_9)
                                                            if (((8 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&myglobal, "dr_write") || __CPROVER_get_field(&myglobal, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = myglobal + 1;
tmain_9:
IF(0,9,tmain_10)
...
IF(0,11,tmain_12)
                                                            if (((11 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&myglobal, "dr_write") || __CPROVER_get_field(&myglobal, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = myglobal + 1;
tmain_12:
IF(0,12,tmain_13)
...
IF(0,14,tmain_15)
                                                            if (((14 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&myglobal, "dr_write") || __CPROVER_get_field(&myglobal, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = myglobal + 1;
tmain_15:
IF(0,15,tmain_16)
...
tmain_16:
IF(0,16,tmain_17)
                                                  __CPROVER_assume(!(__cs_nondet_main_i < 20));
                                                  __exit_loop_2:
                                                  ...
                                                  __cs_nondet_main___cs_tmp_if_cond_1 = __cs_join(__cs_nondet_main_mythread, 0);
...
tmain_17:
IF(0,17,tmain_18)
                                                  if (((17 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
/* thread_function_mutex_0 */
                                                  ...
                                                  if (__cs_dataraceContinue & __cs_active_thread[1])
                                                  {
                                                            ...
                                                            if (__cs_dr_ts == 1)
                                                                      __cs_dataraceDetectionStarted = 1;
                                                            thread_function_mutex_0(__cs_threadargs[1]);
