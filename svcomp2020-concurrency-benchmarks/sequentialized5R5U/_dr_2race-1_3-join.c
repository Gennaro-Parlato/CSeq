 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/ldv-races/race-1_3-join.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[2] = {10, 3};
...
IF(1,1,tthread1_0_2)
                                                  if (((1 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&pdev, "dr_write"))
...
IF(0,0,tmain_1)
                                                  ...
                                                  static int __cs_retval_module_init_1;
                                                            ...
                                                            __cs_nondet_module_init_1___cs_tmp_if_cond_1 = nondet_int();
                                                            if (__cs_nondet_module_init_1___cs_tmp_if_cond_1)
                                                                                {
                                                                      __cs_create(&t1, 0, thread1_0, 0, 1);
...
IF(0,3,tmain_4)
                                                  ...
                                                  ;
                                                  __cs_nondet_main___cs_tmp_if_cond_2 = __cs_retval_module_init_1 != 0;
...
IF(0,4,tmain_5)
                                                            if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&pdev, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            pdev = 4;
                                                                                {
...
tmain_5:
IF(0,5,tmain_6)
                                                                      if (((5 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&pdev, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_param_ldv_assert_3_expression = pdev == 4;
                                                                      ;
                                                                      ;
...
tmain_6:
IF(0,6,tmain_7)
                                                            if (((6 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&t1, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
...
IF(0,8,tmain_9)
                                                            if (((8 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&pdev, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            pdev = 5;
                                                                                {
...
tmain_9:
IF(0,9,tmain_10)
                                                                      if (((9 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&pdev, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_param_ldv_assert_4_expression = pdev == 5;
                                                                      ;
                                                                      ;
