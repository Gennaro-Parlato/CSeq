 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/lazy01.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
tthread1_0_1:
IF(1,1,tthread1_0_2)
                                                  if (((1 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&data, "dr_write"))
...
IF(2,1,tthread2_0_2)
                                                  if (((1 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&data, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  data += 2;
tthread2_0_2:
IF(2,2,tthread2_0_3)
...
tthread3_0_1:
IF(3,1,tthread3_0_2)
                                                  if (((1 == __cs_pc[3]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&data, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
tmain_2:
IF(0,2,tmain_3)
                                                  __cs_create(&__cs_nondet_main_t3, 0, thread3_0, 0, 3);
tmain_3:
IF(0,3,tmain_4)
