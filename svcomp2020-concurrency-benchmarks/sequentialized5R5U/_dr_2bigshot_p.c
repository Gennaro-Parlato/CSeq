 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/bigshot_p.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {5, 1, 3};
...
tthread2_0_1:
IF(2,1,tthread2_0_2)
                                                  if (((1 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&v, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_thread2___cs_tmp_if_cond_1 = v;
                                                  if (__cs_nondet_thread2___cs_tmp_if_cond_1)
                                                            {
tthread2_0_2:
IF(2,2,tthread2_0_3)
                                                            if (((2 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&v, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            strcpy(v, "Bigshot");
                                                  }
...
tmain_4:
IF(0,4,tmain_5)
                                                  if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&v, "dr_write") || __CPROVER_get_field(&v[0], "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
