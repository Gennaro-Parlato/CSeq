 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-C-DAC/pthread-demo-datarace-2.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[2] = {9, 12};
...
IF(1,0,tthread_function_datarace_0_1)
                                                  __cs_nondet_thread_function_datarace_i = 0;
                                                            {
tthread_function_datarace_0_1:
IF(1,1,tthread_function_datarace_0_2)
                                                            if (((1 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thread_function_datarace_j = myglobal;
                                                            __cs_nondet_thread_function_datarace_j = __cs_nondet_thread_function_datarace_j + 1;
...
IF(1,4,tthread_function_datarace_0_5)
                                                            if (((4 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = __cs_nondet_thread_function_datarace_j;
                                                  }
                                                  ;
...
IF(1,5,tthread_function_datarace_0_6)
                                                            if (((5 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thread_function_datarace_j = myglobal;
                                                            __cs_nondet_thread_function_datarace_j = __cs_nondet_thread_function_datarace_j + 1;
                                                            printf("\nIn thread_function_datarace..\t");
...
IF(1,6,tthread_function_datarace_0_7)
...
IF(1,7,tthread_function_datarace_0_8)
...
IF(1,8,tthread_function_datarace_0_9)
                                                            if (((8 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = __cs_nondet_thread_function_datarace_j;
                                                  }
                                                  ;
...
IF(1,9,tthread_function_datarace_0_10)
                                                            if (((9 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thread_function_datarace_j = myglobal;
                                                            __cs_nondet_thread_function_datarace_j = __cs_nondet_thread_function_datarace_j + 1;
                                                            printf("\nIn thread_function_datarace..\t");
...
IF(1,10,tthread_function_datarace_0_11)
                                                  ...
                                                  ;
                                                  __cs_nondet_thread_function_datarace_i++;
tthread_function_datarace_0_11:
IF(1,11,tthread_function_datarace_0_12)
                                                  __CPROVER_assume(!(__cs_nondet_thread_function_datarace_i < 20));
                                                  __exit_loop_1:
                                                  ...
                                                  ;
                                                  ;
tthread_function_datarace_0_12: 
                                                  __cs_exit(0, 1);
                                        }
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_nondet_main___cs_tmp_if_cond_0 = __cs_create(&__cs_nondet_main_mythread, 0, thread_function_datarace_0, 0, 1);
...
IF(0,1,tmain_2)
                                                            if (((1 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&myglobal, "dr_write") || __CPROVER_get_field(&myglobal, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = myglobal + 1;
                                                  }
                                                  ;
...
IF(0,3,tmain_4)
                                                            if (((3 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&myglobal, "dr_write") || __CPROVER_get_field(&myglobal, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = myglobal + 1;
                                                  }
                                                  ;
...
IF(0,4,tmain_5)
                                                            if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&myglobal, "dr_write") || __CPROVER_get_field(&myglobal, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            myglobal = myglobal + 1;
                                                  }
                                                  ;
...
tmain_7:
IF(0,7,tmain_8)
                                                  if (((7 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(myglobal != 40);
tmain_8:
IF(0,8,tmain_9)
                                                  if (((8 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
/* thread_function_datarace_0 */
                                                  ...
                                                  if (__cs_dataraceContinue & __cs_active_thread[1])
                                                  {
                                                            ...
                                                            if (__cs_dr_ts == 1)
                                                                      __cs_dataraceDetectionStarted = 1;
                                                            thread_function_datarace_0(__cs_threadargs[1]);
