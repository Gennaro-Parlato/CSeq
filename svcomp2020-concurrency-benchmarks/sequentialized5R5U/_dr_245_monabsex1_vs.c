 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/45_monabsex1_vs.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        {
                                                  static int __cs_local_thr1_l;
IF(1,0,tthr1_0_1)
                                                  __cs_local_thr1_l = nondet_int();
                                                  __cs_local_thr1_l = 4;
tthr1_0_1:
...
IF(1,2,tthr1_0_3)
                                                            if (((2 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&s, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thr1___cs_tmp_if_cond_0 = !(s == __cs_local_thr1_l);
...
IF(0,0,tmain_1)
                                                  if (((0 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&s, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  s = nondet_int();
