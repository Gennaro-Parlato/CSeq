 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-lit/fkp2014.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
tthr_0_1:
IF(1,1,tthr_0_2)
                                                  if (((1 == __cs_pc[1]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&t, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(s < t);
                                                            {
tthr_0_2:
IF(1,2,tthr_0_3)
                                                            ;
...
tthr_1_1:
IF(2,1,tthr_1_2)
                                                  if (((1 == __cs_pc[2]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&t, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(s < t);
                                                            {
tthr_1_2:
...
tthr_2_1:
IF(3,1,tthr_2_2)
                                                  if (((1 == __cs_pc[3]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&t, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(s < t);
                                                            {
tthr_2_2:
...
tthr_3_1:
IF(4,1,tthr_3_2)
                                                  if (((1 == __cs_pc[4]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&t, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(s < t);
                                                            {
tthr_3_2:
...
tthr_4_1:
IF(5,1,tthr_4_2)
                                                  if (((1 == __cs_pc[5]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&t, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(s < t);
                                                            {
tthr_4_2:
...
IF(0,0,tmain_1)
                                                  ...
                                                  s = 0;
                                                  __cs_nondet_main_n = nondet_int();
                                                  assume_abort_if_not(__cs_nondet_main_n > 0);
                                                  __cs_nondet_main_i = 0;
                                                  if (!(__cs_nondet_main_i < __cs_nondet_main_n))
                                                            {
                                                            goto __exit_loop_1;
                                                            ;
                                                  }
...
tmain_5:
IF(0,5,tmain_6)
                                                  __CPROVER_assume(!(__cs_nondet_main_i < __cs_nondet_main_n));
                                                  __exit_loop_1:
