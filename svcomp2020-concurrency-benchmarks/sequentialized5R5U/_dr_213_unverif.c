 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/13_unverif.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        {
                                                  static unsigned int __cs_local_thr1_l;
IF(1,0,tthr1_0_1)
                                                  __cs_local_thr1_l = 0;
tthr1_0_1:
IF(1,1,tthr1_0_2)
...
tthr1_0_2:
IF(1,2,tthr1_0_3)
                                                  if (((2 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&r, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_thr1___cs_tmp_if_cond_0 = r == 1;
...
IF(1,3,tthr1_0_4)
                                                            if (((3 == __cs_pc[1]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&s, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            s = s + 1;
                                                            __cs_local_thr1_l = __cs_local_thr1_l + 1;
                                                                                {
                                                                      ;
                                                                      ;
...
IF(1,4,tthr1_0_5)
                                                                      if (((4 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&s, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(s == __cs_local_thr1_l);
...
tthr1_1_2:
IF(2,2,tthr1_1_3)
                                                  if (((2 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&r, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_thr1___cs_tmp_if_cond_0 = r == 1;
                                                  if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                            {
...
IF(2,3,tthr1_1_4)
                                                            if (((3 == __cs_pc[2]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&s, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            s = s + 1;
                                                            __cs_local_thr1_l = __cs_local_thr1_l + 1;
                                                                                {
...
tthr1_2_2:
IF(3,2,tthr1_2_3)
                                                  if (((2 == __cs_pc[3]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&r, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_thr1___cs_tmp_if_cond_0 = r == 1;
                                                  if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                            {
...
IF(3,3,tthr1_2_4)
                                                            if (((3 == __cs_pc[3]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&s, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            s = s + 1;
                                                            __cs_local_thr1_l = __cs_local_thr1_l + 1;
                                                                                {
...
tthr1_3_2:
IF(4,2,tthr1_3_3)
                                                  if (((2 == __cs_pc[4]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&r, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_thr1___cs_tmp_if_cond_0 = r == 1;
                                                  if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                            {
...
IF(4,3,tthr1_3_4)
                                                            if (((3 == __cs_pc[4]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&s, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            s = s + 1;
                                                            __cs_local_thr1_l = __cs_local_thr1_l + 1;
                                                                                {
...
tthr1_4_2:
IF(5,2,tthr1_4_3)
                                                  if (((2 == __cs_pc[5]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&r, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_thr1___cs_tmp_if_cond_0 = r == 1;
                                                  if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                            {
...
IF(5,3,tthr1_4_4)
                                                            if (((3 == __cs_pc[5]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&s, "dr_write") || __CPROVER_get_field(&s, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            s = s + 1;
                                                            __cs_local_thr1_l = __cs_local_thr1_l + 1;
                                                                                {
