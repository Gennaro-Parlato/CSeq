 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/18_read_write_lock.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[2] = {8, 3};
...
IF(0,3,tmain_4)
                                                            if (((3 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&y, "dr_write") || __CPROVER_get_field(&x, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            y = x;
                                                                                {
                                                                      ;
...
tmain_4:
IF(0,4,tmain_5)
                                                                      if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&y, "dr_write") || __CPROVER_get_field(&x, "dr_write")))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr2_1___cs_tmp_if_cond_0 = !(y == x);
                                                                      if (__cs_nondet_thr2_1___cs_tmp_if_cond_0)
                                                                                                    {
                                                                                __CPROVER_assume(0);
                                                                                (void) 0;
                                                                      }
...
IF(0,5,tmain_6)
                                                            if (((5 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&r, "dr_write") || __CPROVER_get_field(&r, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
                                                            r = r - 1;
tmain_6:
IF(0,6,tmain_7)
