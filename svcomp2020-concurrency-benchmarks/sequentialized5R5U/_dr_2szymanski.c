 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/szymanski.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {4, 12, 12};
...
tthr2_0_1:
IF(2,1,tthr2_0_2)
                                                  if (((1 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag1, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
IF(2,2,tthr2_0_3)
                                                  if (((2 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag2, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  flag2 = 3;
                                                  ;
                                                  ;
...
tthr2_0_3:
IF(2,3,tthr2_0_4)
                                                  if (((3 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag1, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_thr2___cs_tmp_if_cond_2 = flag1 == 1;
...
IF(2,4,tthr2_0_5)
                                                            if (((4 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag2, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            flag2 = 2;
tthr2_0_5:
IF(2,5,tthr2_0_6)
                                                            if (((5 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag1, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
...
IF(2,6,tthr2_0_7)
                                                  if (((6 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag2, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  flag2 = 4;
tthr2_0_7:
IF(2,7,tthr2_0_8)
...
IF(2,8,tthr2_0_9)
                                                  if (((8 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  x = 1;
                                                  ;
                                                  ;
...
tthr2_0_9:
IF(2,9,tthr2_0_10)
                                                  if (((9 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
tthr2_0_10:
IF(2,10,tthr2_0_11)
                                                  if (((10 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag1, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
IF(2,11,tthr2_0_12)
                                                  if (((11 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag2, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  flag2 = 0;
                                                  goto __exit_thr2;
                                                  ;
