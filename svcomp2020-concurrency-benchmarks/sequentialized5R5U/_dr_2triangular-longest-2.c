 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/triangular-longest-2.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
tt1_0_6:
IF(1,6,tt1_0_7)
                                                            __CPROVER_assume(!(__cs_nondet_t1_k < 20));
                                                            __exit_loop_1:
...
tt2_0_6:
IF(2,6,tt2_0_7)
                                                            __CPROVER_assume(!(__cs_nondet_t2_k < 20));
                                                            __exit_loop_2:
...
IF(0,2,tmain_3)
                                                  ...
                                                  __cs_local_main_condI = i >= (40 + 6);
                                                  ;
tmain_3:
IF(0,3,tmain_4)
                                                  ;
                                                  static int __cs_local_main_condJ;
                                                  __cs_local_main_condJ = j >= (40 + 6);
                                                  ;
                                                  ;
                                                  ;
