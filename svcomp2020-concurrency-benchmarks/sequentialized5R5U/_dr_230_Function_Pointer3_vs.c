 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/30_Function_Pointer3_vs.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[7] = {7, 7, 4, 4, 4, 4, 4};
                                        ...
                                        int f1(int __cs_param_f1_a, int __cs_param_f1_b)
                                        {
                                                  return (__cs_param_f1_a + __cs_param_f1_b) + 1;
                                                  ;
                                        }
                                        int f2(int __cs_param_f2_x, int __cs_param_f2_y)
                                        {
                                                  return (__cs_param_f2_x - __cs_param_f2_y) + 2;
                                                  ;
                                        }
                                        void *thr2_0(void *__cs_param_thr2_arg)
                                        {
                                                  static FuncType __cs_nondet_thr2_pf;
IF(2,0,tthr2_0_1)
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_thr2___cs_tmp_if_cond_0;
                                                  __cs_nondet_thr2___cs_tmp_if_cond_0 = nondet_int();
                                                  if (__cs_nondet_thr2___cs_tmp_if_cond_0)
                                                            {
                                                            __cs_nondet_thr2_pf = f1;
                                                  }
                                                  else
                                                            {
                                                            __cs_nondet_thr2_pf = f2;
                                                  }
                                                  ;
tthr2_0_1:
IF(2,1,tthr2_0_2)
...
tthr2_0_2:
                                                  ...
                                                  {
                                                            __CPROVER_set_field(&res, "dr_write", 1);
                                                  }
IF(2,2,tthr2_0_3)
                                                  if (((2 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  res = __cs_nondet_thr2_pf(4, 3);
tthr2_0_3:
IF(2,3,tthr2_0_4)
...
IF(3,2,tthr2_1_3)
                                                  if (((2 == __cs_pc[3]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  res = __cs_nondet_thr2_pf(4, 3);
tthr2_1_3:
IF(3,3,tthr2_1_4)
...
IF(4,2,tthr2_2_3)
                                                  if (((2 == __cs_pc[4]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  res = __cs_nondet_thr2_pf(4, 3);
tthr2_2_3:
IF(4,3,tthr2_2_4)
...
IF(5,2,tthr2_3_3)
                                                  if (((2 == __cs_pc[5]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  res = __cs_nondet_thr2_pf(4, 3);
tthr2_3_3:
IF(5,3,tthr2_3_4)
...
IF(6,2,tthr2_4_3)
                                                  if (((2 == __cs_pc[6]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  res = __cs_nondet_thr2_pf(4, 3);
tthr2_4_3:
IF(6,3,tthr2_4_4)
...
tthr1_0_1:
IF(1,1,tthr1_0_2)
                                                                      if (((1 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(res < 10);
...
tthr1_0_2:
IF(1,2,tthr1_0_3)
                                                                      if (((2 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(res < 10);
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_1)
                                                                                                    {
...
tthr1_0_3:
IF(1,3,tthr1_0_4)
                                                                      if (((3 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(res < 10);
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_1)
                                                                                                    {
...
tthr1_0_4:
IF(1,4,tthr1_0_5)
                                                                      if (((4 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(res < 10);
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_1)
                                                                                                    {
...
tthr1_0_5:
IF(1,5,tthr1_0_6)
                                                                      if (((5 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&res, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(res < 10);
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_1)
                                                                                                    {
