 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/16_peterson.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[2] = {15, 11};
...
tthr1_0_7:
IF(1,7,tthr1_0_8)
                                                  if (((7 == __cs_pc[1]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&flag2, "dr_write") || __CPROVER_get_field(&turn, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
...
tmain_9:
IF(0,9,tmain_10)
                                                            if (((9 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&flag1, "dr_write") || __CPROVER_get_field(&turn, "dr_write")))
                                                                      __cs_dataraceNotDetected = 0;
