 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/safe012_rmo.oepc.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_create(&__cs_nondet_main_t2061, 0, P0_0, 0, 1);
                                                  static __cs_t __cs_nondet_main_t2062;
tmain_1:
IF(0,1,tmain_2)
                                                  __cs_create(&__cs_nondet_main_t2062, 0, P1_0, 0, 2);
                                                  static __cs_t __cs_nondet_main_t2063;
tmain_2:
IF(0,2,tmain_3)
                                                  __cs_create(&__cs_nondet_main_t2063, 0, P2_0, 0, 3);
tmain_3:
IF(0,3,tmain_4)
                                                  ;
