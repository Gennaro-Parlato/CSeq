 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/sync01.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[3] = {5, 20, 20};
...
tthread1_0_2:
IF(1,2,tthread1_0_3)
                                                            __cs_cond_wait_1(&empty, &m, 1);
tthread1_0_3:
IF(1,3,tthread1_0_4)
                                                            __cs_cond_wait_2(&empty, &m, 1);
                                                            ;
                                                            ;
                                                  }
                                                  ;
...
IF(1,16,tthread1_0_17)
                                                  if (((16 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
...
IF(1,17,tthread1_0_18)
                                                  if (((17 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  num++;
tthread1_0_18:
...
tthread2_0_2:
IF(2,2,tthread2_0_3)
                                                            __cs_cond_wait_1(&full, &m, 2);
tthread2_0_3:
IF(2,3,tthread2_0_4)
                                                            __cs_cond_wait_2(&full, &m, 2);
                                                            ;
                                                            ;
                                                  }
                                                  ;
...
IF(2,16,tthread2_0_17)
                                                  if (((16 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(num == 0));
                                                  __exit_loop_2:
...
IF(2,17,tthread2_0_18)
                                                  if (((17 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  num--;
tthread2_0_18:
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_create(&__cs_nondet_main_t1, 0, thread1_0, 0, 1);
tmain_1:
IF(0,1,tmain_2)
                                                  __cs_create(&__cs_nondet_main_t2, 0, thread2_0, 0, 2);
tmain_2:
IF(0,2,tmain_3)
...
tmain_4:
IF(0,4,tmain_5)
                                                  if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_main___cs_tmp_if_cond_0 = num != 1;
