 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/bigshot_s2.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
tmain_4:
IF(0,4,tmain_5)
                                                  if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&v[0], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(v[0] == 'B');
                                                  goto __exit_main;
                                                  ;
                                                  __exit_main:
