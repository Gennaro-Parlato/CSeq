 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/29_conditionals_vs.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
IF(1,1,tthr1_0_2)
                                                  ...
                                                  if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                            {
                                                            __cs_nondet_thr1_z = 0;
                                                  }
                                                  else
                                                            {
                                                            __cs_nondet_thr1_z = 1;
                                                  }
                                                  ;
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_thr1___cs_tmp_if_cond_1;
                                                  __cs_nondet_thr1___cs_tmp_if_cond_1 = __cs_nondet_thr1_z == 0;
