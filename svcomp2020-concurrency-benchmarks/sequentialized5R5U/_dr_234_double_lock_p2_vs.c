 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/34_double_lock_p2_vs.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[7] = {7, 31, 9, 9, 9, 9, 9};
...
tthr1_0_16:
IF(1,16,tthr1_0_17)
                                                                      if (((16 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&count, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(count <= 1);
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_1)
                                                                                                    {
...
tthr1_0_19:
IF(1,19,tthr1_0_20)
                                                                      if (((19 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&count, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_0 = !(count >= (-1));
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                                                                    {
...
tthr1_0_22:
IF(1,22,tthr1_0_23)
                                                                      if (((22 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&count, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(count <= 1);
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_1)
                                                                                                    {
...
tthr1_0_25:
IF(1,25,tthr1_0_26)
                                                                      if (((25 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&count, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_0 = !(count >= (-1));
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_0)
                                                                                                    {
...
tthr1_0_28:
IF(1,28,tthr1_0_29)
                                                                      if (((28 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&count, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(count <= 1);
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_1)
                                                                                                    {
