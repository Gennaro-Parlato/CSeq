 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/ldv-races/race-1_2-join.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
IF(0,2,tmain_3)
                                                                                if (((2 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&pdev, "dr_write"))
                                                                                          __cs_dataraceNotDetected = 0;
                                                                                __cs_param_ldv_assert_2_expression = pdev == 2;
                                                                                ;
                                                                                ;
...
IF(0,3,tmain_4)
                                                            if (((3 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&pdev, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            pdev = 3;
                                                                                {
...
IF(0,4,tmain_5)
                                                                      if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&pdev, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_param_ldv_assert_3_expression = pdev == 3;
                                                                      ;
                                                                      ;
