 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/read_write_lock-2.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {8, 3, 6, 3, 6};
...
twriter_0_2:
                                                  ...
                                                  {
                                                            __CPROVER_set_field(&w, "dr_write", 1);
                                                  }
IF(1,2,twriter_0_3)
                                                  if (((2 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&w, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  w = 0;
                                                  goto __exit_writer;
                                                  ;
...
IF(3,2,twriter_1_3)
                                                  if (((2 == __cs_pc[3]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&w, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  w = 0;
                                                  goto __exit_writer;
                                                  ;
...
IF(2,2,treader_0_3)
                                                  if (((2 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&y, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  y = __cs_nondet_reader_l;
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_reader___cs_tmp_if_cond_0;
treader_0_3:
IF(2,3,treader_0_4)
                                                  if (((3 == __cs_pc[2]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&y, "dr_write") || __CPROVER_get_field(&x, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_reader___cs_tmp_if_cond_0 = !(y == x);
                                                  if (__cs_nondet_reader___cs_tmp_if_cond_0)
                                                            {
                                                            __CPROVER_assume(0);
                                                  }
                                                  ;
treader_0_4:
IF(2,4,treader_0_5)
                                                  if (((4 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&r, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_reader_l = r - 1;
treader_0_5:
                                                  if (((5 == __cs_pc_cs[2]) & __cs_dataraceDetectionStarted) & (!__cs_dataraceSecondThread))
                                                  {
                                                            __CPROVER_set_field(&r, "dr_write", 1);
                                                  }
IF(2,5,treader_0_6)
                                                  if (((5 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&r, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  r = __cs_nondet_reader_l;
                                                  goto __exit_reader;
                                                  ;
                                                  __exit_reader:
...
IF(4,2,treader_1_3)
                                                  if (((2 == __cs_pc[4]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&y, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  y = __cs_nondet_reader_l;
                                                  ;
                                                  ;
...
treader_1_3:
IF(4,3,treader_1_4)
                                                  if (((3 == __cs_pc[4]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&y, "dr_write") || __CPROVER_get_field(&x, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_reader___cs_tmp_if_cond_0 = !(y == x);
                                                  if (__cs_nondet_reader___cs_tmp_if_cond_0)
                                                            {
...
treader_1_4:
IF(4,4,treader_1_5)
                                                  if (((4 == __cs_pc[4]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&r, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_reader_l = r - 1;
treader_1_5:
...
IF(4,5,treader_1_6)
                                                  if (((5 == __cs_pc[4]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&r, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  r = __cs_nondet_reader_l;
                                                  goto __exit_reader;
                                                  ;
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_create(&__cs_nondet_main_t1, 0, writer_0, 0, 1);
tmain_1:
IF(0,1,tmain_2)
                                                  __cs_create(&__cs_nondet_main_t2, 0, reader_0, 0, 2);
tmain_2:
IF(0,2,tmain_3)
                                                  __cs_create(&__cs_nondet_main_t3, 0, writer_1, 0, 3);
tmain_3:
IF(0,3,tmain_4)
                                                  __cs_create(&__cs_nondet_main_t4, 0, reader_1, 0, 4);
tmain_4:
IF(0,4,tmain_5)
...
tmain_7:
IF(0,7,tmain_8)
                                                  __cs_join(__cs_nondet_main_t4, 0);
                                                  goto __exit_main;
                                                  ;
                                                  __exit_main:
