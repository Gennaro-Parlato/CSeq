 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/sigma.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[6] __cs_thread_lines[6] = {37, 1, 1, 1, 1, 1};
                                        ...
                                        void *thread_0(void *__cs_param_thread_arg)
                                        {
                                                  ...
                                                  {
                                                            __CPROVER_set_field(&array[array_index], "dr_write", 1);
                                                  }
IF(1,0,tthread_0_1)
                                                  if (((0 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[array_index], "dr_write"))
...
IF(2,0,tthread_1_1)
                                                  if (((0 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[array_index], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  array[array_index] = 1;
                                                  goto __exit_thread;
                                                  ;
...
IF(3,0,tthread_2_1)
                                                  if (((0 == __cs_pc[3]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[array_index], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  array[array_index] = 1;
                                                  goto __exit_thread;
                                                  ;
...
IF(4,0,tthread_3_1)
                                                  if (((0 == __cs_pc[4]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[array_index], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  array[array_index] = 1;
                                                  goto __exit_thread;
                                                  ;
...
IF(5,0,tthread_4_1)
                                                  if (((0 == __cs_pc[5]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[array_index], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  array[array_index] = 1;
                                                  goto __exit_thread;
                                                  ;
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_nondet_main_t = (__cs_t *) __cs_safe_malloc((sizeof(__cs_t)) * SIGMA);
                                                  array = (int *) __cs_safe_malloc((sizeof(int)) * SIGMA);
                                                  assume_abort_if_not(__cs_nondet_main_t);
                                                  assume_abort_if_not(array);
                                                  __cs_nondet_main_tid = 0;
                                                  if (!(__cs_nondet_main_tid < SIGMA))
                                                            {
                                                            goto __exit_loop_1;
                                                            ;
                                                  }
                                                  ;
                                                            {
                                                            array_index++;
                                                            __cs_create(&__cs_nondet_main_t[__cs_nondet_main_tid], 0, thread_0, 0, 1);
                                                  }
                                                  ;
                                                  __cs_nondet_main_tid++;
tmain_1:
IF(0,1,tmain_2)
                                                  if (!(__cs_nondet_main_tid < SIGMA))
                                                            {
...
tmain_2:
IF(0,2,tmain_3)
                                                            if (((2 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array_index, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            array_index++;
tmain_3:
IF(0,3,tmain_4)
                                                            __cs_create(&__cs_nondet_main_t[__cs_nondet_main_tid], 0, thread_1, 0, 2);
                                                  }
                                                  ;
                                                  __cs_nondet_main_tid++;
tmain_4:
...
tmain_5:
IF(0,5,tmain_6)
                                                            if (((5 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array_index, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            array_index++;
tmain_6:
IF(0,6,tmain_7)
                                                            __cs_create(&__cs_nondet_main_t[__cs_nondet_main_tid], 0, thread_2, 0, 3);
                                                  }
                                                  ;
                                                  __cs_nondet_main_tid++;
tmain_7:
...
tmain_8:
IF(0,8,tmain_9)
                                                            if (((8 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array_index, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            array_index++;
tmain_9:
IF(0,9,tmain_10)
                                                            __cs_create(&__cs_nondet_main_t[__cs_nondet_main_tid], 0, thread_3, 0, 4);
                                                  }
                                                  ;
                                                  __cs_nondet_main_tid++;
tmain_10:
...
tmain_11:
IF(0,11,tmain_12)
                                                            if (((11 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array_index, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            array_index++;
tmain_12:
IF(0,12,tmain_13)
                                                            __cs_create(&__cs_nondet_main_t[__cs_nondet_main_tid], 0, thread_4, 0, 5);
                                                  }
                                                  ;
                                                  __cs_nondet_main_tid++;
tmain_13:
IF(0,13,tmain_14)
                                                  if (((13 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(__cs_nondet_main_tid < SIGMA));
                                                  __exit_loop_1:
...
tmain_15:
IF(0,15,tmain_16)
                                                            __cs_join(__cs_nondet_main_t[__cs_nondet_main_tid], 0);
                                                  }
                                                  ;
                                                  __cs_nondet_main_tid++;
tmain_16:
...
tmain_24:
IF(0,24,tmain_25)
                                                  if (((24 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(__cs_nondet_main_tid < SIGMA));
                                                  __exit_loop_2:
                                                  ...
                                                  ;
                                                  ;
                                                  __cs_nondet_main_tid = (__cs_nondet_main_sum = 0);
tmain_25:
IF(0,25,tmain_26)
                                                  if (!(__cs_nondet_main_tid < SIGMA))
                                                            {
...
tmain_26:
IF(0,26,tmain_27)
                                                            if (((26 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
                                                  __cs_nondet_main_tid++;
tmain_27:
...
tmain_28:
IF(0,28,tmain_29)
                                                            if (((28 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
...
tmain_30:
IF(0,30,tmain_31)
                                                            if (((30 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
...
tmain_32:
IF(0,32,tmain_33)
                                                            if (((32 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
...
tmain_34:
IF(0,34,tmain_35)
                                                            if (((34 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
...
tmain_35:
IF(0,35,tmain_36)
                                                  if (((35 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(__cs_nondet_main_tid < SIGMA));
                                                  __exit_loop_3:
...
tmain_36:
IF(0,36,tmain_37)
                                                  if (((36 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(__cs_nondet_main_sum == SIGMA);
                                                  goto __exit_main;
                                                  ;
                                                  __exit_main:
...
/* thread_3 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t4_r2;
...
/* thread_4 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t5_r2;
...
/* thread_1 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t2_r3;
...
/* thread_2 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t3_r3;
...
/* thread_3 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t4_r3;
...
/* thread_4 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t5_r3;
...
/* thread_1 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t2_r4;
...
/* thread_2 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t3_r4;
...
/* thread_3 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t4_r4;
...
/* thread_4 */
                                                  unsigned __CPROVER_bitvector[1] __cs_tmp_t5_r4;
