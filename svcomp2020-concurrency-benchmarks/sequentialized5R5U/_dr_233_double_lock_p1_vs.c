 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/33_double_lock_p1_vs.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
tthr1_0_21:
IF(1,21,tthr1_0_22)
                                                                      if (((21 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&count, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(count == 0);
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_1)
                                                                                                    {
...
tthr1_0_27:
IF(1,27,tthr1_0_28)
                                                                      if (((27 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&count, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_thr1___cs_tmp_if_cond_1 = !(count == 0);
                                                                      if (__cs_nondet_thr1___cs_tmp_if_cond_1)
                                                                                                    {
