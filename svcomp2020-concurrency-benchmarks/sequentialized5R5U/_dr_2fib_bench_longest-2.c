 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/fib_bench_longest-2.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {4, 7, 7};
...
IF(0,2,tmain_3)
                                                  ...
                                                  __cs_local_main_condI = i >= 46368;
                                                  ;
tmain_3:
IF(0,3,tmain_4)
                                                  ;
                                                  static int __cs_local_main_condJ;
                                                  __cs_local_main_condJ = j >= 46368;
                                                  ;
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_main___cs_tmp_if_cond_1;
                                                  __cs_nondet_main___cs_tmp_if_cond_1 = __cs_local_main_condI || __cs_local_main_condJ;
