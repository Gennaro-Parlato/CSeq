 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/stack_longest-2.i, --rounds 5, --unwind 5, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[6] __cs_thread_lines[3] = {4, 37, 42};
...
tt1_0_9:
IF(1,9,tt1_0_10)
                                                                      if (((9 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&arr, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_param_push_1_stack = arr;
                                                                      static int __cs_param_push_1_x;
                                                                      __cs_param_push_1_x = __cs_nondet_t1_tmp;
...
tt1_0_10:
IF(1,10,tt1_0_11)
                                                                      if (((10 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&top, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_push_1___cs_tmp_if_cond_0 = top == 800;
                                                                      if (__cs_nondet_push_1___cs_tmp_if_cond_0)
                                                                                                    {
...
tt1_0_16:
IF(1,16,tt1_0_17)
                                                                      if (((16 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&arr, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_param_push_1_stack = arr;
                                                                      static int __cs_param_push_1_x;
                                                                      __cs_param_push_1_x = __cs_nondet_t1_tmp;
...
tt1_0_17:
IF(1,17,tt1_0_18)
                                                                      if (((17 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&top, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_push_1___cs_tmp_if_cond_0 = top == 800;
                                                                      if (__cs_nondet_push_1___cs_tmp_if_cond_0)
                                                                                                    {
...
tt1_0_23:
IF(1,23,tt1_0_24)
                                                                      if (((23 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&arr, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_param_push_1_stack = arr;
                                                                      static int __cs_param_push_1_x;
                                                                      __cs_param_push_1_x = __cs_nondet_t1_tmp;
...
tt1_0_30:
IF(1,30,tt1_0_31)
                                                                      if (((30 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&arr, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_param_push_1_stack = arr;
                                                                      static int __cs_param_push_1_x;
                                                                      __cs_param_push_1_x = __cs_nondet_t1_tmp;
...
IF(2,2,tt2_0_3)
                                                            if (((2 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&top, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_t2___cs_tmp_if_cond_3 = top > 0;
...
IF(2,4,tt2_0_5)
                                                                                if (((4 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&top, "dr_write"))
                                                                                          __cs_dataraceNotDetected = 0;
                                                                                __cs_nondet_pop_1___cs_tmp_if_cond_1 = top == 0;
...
tt2_0_7:
IF(2,7,tt2_0_8)
                                                                                          __cs_retval_pop_1 = __cs_param_pop_1_stack[__cs_retval_get_top_1];
                                                                                          goto __exit_pop_1;
                                                                                          ;
                                                                                }
...
tt2_0_10:
IF(2,10,tt2_0_11)
                                                            if (((10 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&top, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_t2___cs_tmp_if_cond_3 = top > 0;
                                                            if (__cs_nondet_t2___cs_tmp_if_cond_3)
                                                                                {
