 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/23_lu-fig2.fixed.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        void __CSEQ_atomic_thr1(int __cs_param___CSEQ_atomic_thr1_PR_CreateThread__RES)
                                        {
                                                  ...
                                                  __cs_nondet___CSEQ_atomic_thr1___cs_tmp_if_cond_0 = __COUNT__ == 0;
                                                  if (__cs_nondet___CSEQ_atomic_thr1___cs_tmp_if_cond_0)
                                                            {
                                                            mThread = __cs_param___CSEQ_atomic_thr1_PR_CreateThread__RES;
                                                  ...
                                                  else
                                                            {
                                                                      ...
                                                                      __cs_nondet___CSEQ_atomic_thr1___cs_tmp_if_cond_1 = !0;
                                                                      if (__cs_nondet___CSEQ_atomic_thr1___cs_tmp_if_cond_1)
                                                                                                    {
                                                                                __CPROVER_assume(0);
                                                                                (void) 0;
                                                                      }
                                        ...
                                        {
                                                  static int __cs_local_thr1_PR_CreateThread__RES;
IF(1,0,tthr1_0_1)
                                                  __cs_local_thr1_PR_CreateThread__RES = 1;
tthr1_0_1:
IF(1,1,tthr1_0_2)
...
tthr1_0_2:
                                                  ...
                                                  {
                                                            __CPROVER_set_field(&start_main, "dr_write", 1);
                                                  }
IF(1,2,tthr1_0_3)
                                                  if (((2 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&start_main, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  start_main = 1;
tthr1_0_3:
IF(1,3,tthr1_0_4)
                                                  __CSEQ_atomic_thr1(__cs_local_thr1_PR_CreateThread__RES);
tthr1_0_4:
IF(1,4,tthr1_0_5)
...
tthr1_0_5: 
                                        ...
                                        void __CSEQ_atomic_thr2(int __cs_param___CSEQ_atomic_thr2_self)
                                        {
                                                  ...
                                                  __cs_nondet___CSEQ_atomic_thr2___cs_tmp_if_cond_2 = __COUNT__ == 1;
                                                  if (__cs_nondet___CSEQ_atomic_thr2___cs_tmp_if_cond_2)
                                                            {
                                                            __COUNT__ = __COUNT__ + 1;
                                                  }
                                                  else
                                                            {
                                                                      ...
                                                                      __cs_nondet___CSEQ_atomic_thr2___cs_tmp_if_cond_3 = !0;
                                                                      if (__cs_nondet___CSEQ_atomic_thr2___cs_tmp_if_cond_3)
                                                                                                    {
                                                                                __CPROVER_assume(0);
                                                                                (void) 0;
                                                                      }
...
IF(0,1,tmain_2)
                                                            ...
                                                            static int __cs_local_thr2_1_self;
tmain_2:
IF(0,2,tmain_3)
                                                            if (((2 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&mThread, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_local_thr2_1_self = mThread;
tmain_3:
IF(0,3,tmain_4)
                                                            if (((3 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&start_main, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
...
tmain_6:
IF(0,6,tmain_7)
                                                            __CSEQ_atomic_thr2(__cs_local_thr2_1_self);
tmain_7:
IF(0,7,tmain_8)
