 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/singleton_with-uninit-problems.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[7] = {3, 1, 1, 1, 1, 1, 10};
                                        ...
                                        void *thread1_0(void *__cs_param_thread1_arg)
                                        {
                                                  ...
                                                  {
                                                            __CPROVER_set_field(&v, "dr_write", 1);
                                                  }
IF(1,0,tthread1_0_1)
                                                  if (((0 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&v, "dr_write"))
...
tthread1_0_1: 
                                        ...
                                        void *thread2_0(void *__cs_param_thread2_arg)
                                        {
                                                  ...
                                                  {
                                                            __CPROVER_set_field(&v[0], "dr_write", 1);
                                                  }
IF(2,0,tthread2_0_1)
                                                  if (((0 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&v[0], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  v[0] = 'X';
                                                  goto __exit_thread2;
                                                  ;
...
IF(4,0,tthread2_1_1)
                                                  if (((0 == __cs_pc[4]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&v[0], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  v[0] = 'X';
                                                  goto __exit_thread2;
                                                  ;
...
IF(5,0,tthread2_2_1)
                                                  if (((0 == __cs_pc[5]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&v[0], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  v[0] = 'X';
                                                  goto __exit_thread2;
                                                  ;
...
IF(3,0,tthread3_0_1)
                                                  if (((0 == __cs_pc[3]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&v[0], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  v[0] = 'Y';
                                                  goto __exit_thread3;
                                                  ;
...
tthread3_0_1: 
                                        ...
                                        {
                                                  static __cs_t __cs_nondet_thread0_t1;
                                                  static __cs_t __cs_nondet_thread0_t2;
                                                  static __cs_t __cs_nondet_thread0_t3;
                                                  static __cs_t __cs_nondet_thread0_t4;
                                                  static __cs_t __cs_nondet_thread0_t5;
IF(6,0,tthread0_0_1)
                                                  __cs_create(&__cs_nondet_thread0_t1, 0, thread1_0, 0, 1);
tthread0_0_1:
IF(6,1,tthread0_0_2)
                                                  __cs_join(__cs_nondet_thread0_t1, 0);
tthread0_0_2:
IF(6,2,tthread0_0_3)
                                                  __cs_create(&__cs_nondet_thread0_t2, 0, thread2_0, 0, 2);
tthread0_0_3:
IF(6,3,tthread0_0_4)
                                                  __cs_create(&__cs_nondet_thread0_t3, 0, thread3_0, 0, 3);
tthread0_0_4:
IF(6,4,tthread0_0_5)
                                                  __cs_create(&__cs_nondet_thread0_t4, 0, thread2_1, 0, 4);
tthread0_0_5:
IF(6,5,tthread0_0_6)
                                                  __cs_create(&__cs_nondet_thread0_t5, 0, thread2_2, 0, 5);
tthread0_0_6:
IF(6,6,tthread0_0_7)
                                                  __cs_join(__cs_nondet_thread0_t2, 0);
tthread0_0_7:
IF(6,7,tthread0_0_8)
                                                  __cs_join(__cs_nondet_thread0_t3, 0);
tthread0_0_8:
IF(6,8,tthread0_0_9)
                                                  __cs_join(__cs_nondet_thread0_t4, 0);
tthread0_0_9:
IF(6,9,tthread0_0_10)
                                                  __cs_join(__cs_nondet_thread0_t5, 0);
                                                  goto __exit_thread0;
                                                  ;
                                                  __exit_thread0:
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_create(&__cs_nondet_main_t, 0, thread0_0, 0, 6);
tmain_1:
IF(0,1,tmain_2)
                                                  __cs_join(__cs_nondet_main_t, 0);
tmain_2:
IF(0,2,tmain_3)
                                                  if (((2 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&v[0], "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume((v[0] == 'X') || (v[0] == 'Y'));
                                                  goto __exit_main;
                                                  ;
                                                  __exit_main:
...
/* thread0_0 */
                                                  ...
                                                  unsigned __CPROVER_bitvector[2] __cs_tmp_t0_r5;
                                                  if (((__cs_dr_ts > 21) & __cs_dataraceContinue) & __cs_active_thread[0])
                                                  {
