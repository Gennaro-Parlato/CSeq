 ...
 *
 *  params:
 *    -l datarace, -i ../svcomp2020-concurrency-benchmarks/pthread-divine/tls_destructor_worker.i, --rounds 5, --unwind 3, --seq , --local-vars 2, --debug , 
 *
 */
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_nondet_main___cs_tmp_if_cond_2 = !(__cs_local_main_r == 0);
