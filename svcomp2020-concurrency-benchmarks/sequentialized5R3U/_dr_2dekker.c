 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/dekker.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[3] = {4, 21, 21};
...
tthr1_0_16:
IF(1,16,tthr1_0_17)
                                                  if (((16 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag2, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
tthr1_0_18:
IF(1,18,tthr1_0_19)
                                                  if (((18 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
tthr2_0_16:
IF(2,16,tthr2_0_17)
                                                  if (((16 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&flag1, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
tthr2_0_18:
IF(2,18,tthr2_0_19)
                                                  if (((18 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
