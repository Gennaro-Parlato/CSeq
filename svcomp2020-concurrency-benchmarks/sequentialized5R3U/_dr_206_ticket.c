 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/06_ticket.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {4, 9, 9, 9};
...
tthr1_0_8:
IF(1,8,tthr1_0_9)
                                                            if (((8 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&now_serving, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            now_serving++;
...
tthr1_1_8:
IF(2,8,tthr1_1_9)
                                                            if (((8 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&now_serving, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            now_serving++;
                                                            __exit_release_lock_1:
...
tthr1_2_8:
IF(3,8,tthr1_2_9)
                                                            if (((8 == __cs_pc[3]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&now_serving, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            now_serving++;
                                                            __exit_release_lock_1:
