 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/sync01.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {5, 14, 14};
...
IF(1,10,tthread1_0_11)
                                                  if (((10 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
...
IF(1,11,tthread1_0_12)
                                                  if (((11 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  num++;
tthread1_0_12:
...
IF(2,10,tthread2_0_11)
                                                  if (((10 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(num == 0));
                                                  __exit_loop_2:
...
IF(2,11,tthread2_0_12)
                                                  if (((11 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&num, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  num--;
tthread2_0_12:
