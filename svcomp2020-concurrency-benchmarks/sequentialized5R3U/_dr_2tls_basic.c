 ...
 *
 *  params:
 *    -l datarace, -i ../svcomp2020-concurrency-benchmarks/pthread-divine/tls_basic.i, --rounds 5, --unwind 3, --seq , --local-vars 2, --debug , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[2] = {2, 4};
                                        ...
                                        {
                                                  static __cs_key_t *__cs_local_worker_key;
IF(1,0,tworker_0_1)
                                                  __cs_local_worker_key = __cs_param_worker_k;
                                                  static long __cs_local_worker_val;
tworker_0_1:
IF(1,1,tworker_0_2)
                                                  if (((1 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(__cs_local_worker_key, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_local_worker_val = (long) __cs_getspecific(*__cs_local_worker_key);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_worker___cs_tmp_if_cond_0;
                                                  __cs_nondet_worker___cs_tmp_if_cond_0 = !(__cs_local_worker_val == 0);
                                                  if (__cs_nondet_worker___cs_tmp_if_cond_0)
                                                            {
                                                                                {
                                                  ...
                                                  ;
                                                  ;
                                                  static int __cs_local_worker_r;
tworker_0_2:
IF(1,2,tworker_0_3)
                                                  if (((2 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(__cs_local_worker_key, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_local_worker_r = __cs_setspecific(*__cs_local_worker_key, (void *) 42);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_worker___cs_tmp_if_cond_1;
                                                  __cs_nondet_worker___cs_tmp_if_cond_1 = !(__cs_local_worker_r == 0);
                                                  if (__cs_nondet_worker___cs_tmp_if_cond_1)
                                                            {
                                                                                {
...
tworker_0_3:
IF(1,3,tworker_0_4)
                                                  if (((3 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(__cs_local_worker_key, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_local_worker_val = (long) __cs_getspecific(*__cs_local_worker_key);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_worker___cs_tmp_if_cond_2;
                                                  __cs_nondet_worker___cs_tmp_if_cond_2 = !(__cs_local_worker_val == 42);
                                                  if (__cs_nondet_worker___cs_tmp_if_cond_2)
                                                            {
                                                                                {
...
IF(0,0,tmain_1)
                                                  ...
                                                  static int __cs_local_main_r;
                                                  __cs_local_main_r = __cs_key_create(&__cs_nondet_main_key);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_main___cs_tmp_if_cond_3;
                                                  __cs_nondet_main___cs_tmp_if_cond_3 = !(__cs_local_main_r == 0);
                                                  ...
                                                  static long __cs_local_main_val;
                                                  __cs_local_main_val = (long) __cs_getspecific(__cs_nondet_main_key);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_main___cs_tmp_if_cond_4;
                                                  __cs_nondet_main___cs_tmp_if_cond_4 = !(__cs_local_main_val == 0);
                                                  ...
                                                  ;
                                                  ;
                                                  __cs_create(&__cs_nondet_main_tid, 0, worker_0, &__cs_nondet_main_key, 1);
                                                  __cs_local_main_val = (long) __cs_getspecific(__cs_nondet_main_key);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_main___cs_tmp_if_cond_5;
                                                  __cs_nondet_main___cs_tmp_if_cond_5 = !(__cs_local_main_val == 0);
                                                  ...
                                                  ;
                                                  ;
                                                  __cs_local_main_r = __cs_setspecific(__cs_nondet_main_key, (void *) 16);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_main___cs_tmp_if_cond_6;
                                                  __cs_nondet_main___cs_tmp_if_cond_6 = !(__cs_local_main_r == 0);
                                                  ...
                                                  __cs_nondet_main___cs_tmp_if_cond_7 = !(__cs_local_main_val == 16);
...
tmain_1:
IF(0,1,tmain_2)
                                                  __cs_join(__cs_nondet_main_tid, 0);
                                                  __cs_local_main_val = (long) __cs_getspecific(__cs_nondet_main_key);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_main___cs_tmp_if_cond_8;
                                                  __cs_nondet_main___cs_tmp_if_cond_8 = !(__cs_local_main_val == 16);
