 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-divine/condvar.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[2] = {8, 14};
...
IF(1,11,tthread_0_12)
                                                  if (((11 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x_set, "dr_write"))
...
IF(0,5,tmain_6)
                                                  if (((5 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&x_set, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  x_set = 1;
tmain_6:
IF(0,6,tmain_7)
