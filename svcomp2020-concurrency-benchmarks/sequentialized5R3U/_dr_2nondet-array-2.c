 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-nondet/nondet-array-2.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {12, 3, 3, 3};
...
tmain_8:
IF(0,8,tmain_9)
                                                            if (((8 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&a[__cs_nondet_main_i], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
...
tmain_9:
IF(0,9,tmain_10)
                                                            if (((9 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&a[__cs_nondet_main_i], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_local_main_sum += a[__cs_nondet_main_i];
                                                  }
                                                  ;
