 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/19_time_var_mutex.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[2] = {9, 9};
...
IF(1,1,tthr1_0_2)
                                                  ...
                                                  __cs_nondet_thr1___cs_tmp_if_cond_0 = inode == 0;
...
IF(1,7,tthr1_0_8)
                                                            if (((7 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&block, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thr1___cs_tmp_if_cond_1 = !(block == 1);
...
tmain_3:
IF(0,3,tmain_4)
                                                            if (((3 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&busy, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_thr2_1___cs_tmp_if_cond_2 = busy == 0;
...
IF(0,4,tmain_5)
                                                                      if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&block, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      block = 0;
                                                                                                    {
                                                                                ;
...
tmain_5:
IF(0,5,tmain_6)
                                                                                if (((5 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&block, "dr_write"))
                                                                                          __cs_dataraceNotDetected = 0;
                                                                                __cs_nondet_thr2_1___cs_tmp_if_cond_3 = !(block == 0);
