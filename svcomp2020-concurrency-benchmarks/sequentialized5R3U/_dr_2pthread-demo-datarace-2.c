 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-C-DAC/pthread-demo-datarace-2.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[2] = {7, 8};
...
tmain_5:
IF(0,5,tmain_6)
                                                  if (((5 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&myglobal, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
