 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/mix017_rmo.oepc.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_create(&__cs_nondet_main_t449, 0, P0_0, 0, 1);
                                                  static __cs_t __cs_nondet_main_t450;
tmain_1:
IF(0,1,tmain_2)
                                                  __cs_create(&__cs_nondet_main_t450, 0, P1_0, 0, 2);
                                                  static __cs_t __cs_nondet_main_t451;
tmain_2:
IF(0,2,tmain_3)
                                                  __cs_create(&__cs_nondet_main_t451, 0, P2_0, 0, 3);
                                                  static __cs_t __cs_nondet_main_t452;
tmain_3:
IF(0,3,tmain_4)
                                                  __cs_create(&__cs_nondet_main_t452, 0, P3_0, 0, 4);
tmain_4:
IF(0,4,tmain_5)
                                                  ;
