 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/48_ticket_lock_low_contention_vs.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {13, 6, 6, 6};
...
IF(0,7,tmain_8)
                                                            if (((7 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&c, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            c = 1;
                                                                                {
                                                                      ;
