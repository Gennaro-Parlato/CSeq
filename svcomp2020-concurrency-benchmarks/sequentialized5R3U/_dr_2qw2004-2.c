 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-lit/qw2004-2.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[2] = {9, 5};
...
IF(1,1,tBCSP_PnpStop_0_2)
                                                                      ;
                                                                      pendingIo--;
                                                                      static int __cs_local_dec_1_tmp;
                                                                      __cs_local_dec_1_tmp = pendingIo;
                                                                      ;
                                                                      __cs_retval_dec_1 = __cs_local_dec_1_tmp;
                                                                      goto __exit_dec_1;
                                                                      ;
                                                                      __exit_dec_1:
                                                            ...
                                                            __cs_nondet_BCSP_IoDecrement_1___cs_tmp_if_cond_1 = __cs_nondet_BCSP_IoDecrement_1_pending == 0;
...
tBCSP_PnpStop_0_2:
                                                                      ...
                                                                      {
                                                                                __CPROVER_set_field(&stoppingEvent, "dr_write", 1);
                                                                      }
...
IF(1,3,tBCSP_PnpStop_0_4)
                                                  if (((3 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&stoppingEvent, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
IF(1,4,tBCSP_PnpStop_0_5)
                                                  if (((4 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&stopped, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  stopped = 1;
...
tmain_1:
IF(0,1,tmain_2)
                                                            __cs_param_BCSP_PnpAdd_1_arg = 0;
...
tmain_2:
IF(0,2,tmain_3)
                                                                      if (((2 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&stoppingFlag, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
...
tmain_3:
                                                                                ...
                                                                                {
                                                                                          __CPROVER_set_field(&pendingIo, "dr_write", 1);
                                                                                }
IF(0,3,tmain_4)
                                                                                if (((3 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&pendingIo, "dr_write") || __CPROVER_get_field(&pendingIo, "dr_write")))
                                                                                          __cs_dataraceNotDetected = 0;
                                                            ...
                                                            ;
                                                            __cs_nondet_BCSP_PnpAdd_1_status = __cs_retval_BCSP_IoIncrement_1;
                                                            ;
                                                            ;
                                                            static _Bool __cs_nondet_BCSP_PnpAdd_1___cs_tmp_if_cond_2;
                                                            __cs_nondet_BCSP_PnpAdd_1___cs_tmp_if_cond_2 = __cs_nondet_BCSP_PnpAdd_1_status == 0;
                                                            if (__cs_nondet_BCSP_PnpAdd_1___cs_tmp_if_cond_2)
                                                                                {
tmain_4:
IF(0,4,tmain_5)
                                                                      if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&stopped, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
...
IF(0,6,tmain_7)
                                                                                if (((6 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&stoppingEvent, "dr_write"))
                                                                                          __cs_dataraceNotDetected = 0;
                                                                                stoppingEvent = 1;
                                                                      }
