 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/stateful01-1.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {5, 6, 6};
...
tthread1_0_1:
IF(1,1,tthread1_0_2)
                                                  if (((1 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&data1, "dr_write"))
...
tthread1_0_4:
IF(1,4,tthread1_0_5)
                                                  if (((4 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&data2, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  data2++;
tthread1_0_5:
IF(1,5,tthread1_0_6)
...
tthread1_0_6: 
                                        ...
                                        {
IF(2,0,tthread2_0_1)
                                                  __cs_mutex_lock(&ma, 2);
tthread2_0_1:
                                                  if (((1 == __cs_pc_cs[2]) & __cs_dataraceDetectionStarted) & (!__cs_dataraceSecondThread))
                                                  {
                                                            __CPROVER_set_field(&data1, "dr_write", 1);
                                                  }
IF(2,1,tthread2_0_2)
                                                  if (((1 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&data1, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  data1 += 5;
tthread2_0_2:
IF(2,2,tthread2_0_3)
                                                  __cs_mutex_unlock(&ma, 2);
tthread2_0_3:
IF(2,3,tthread2_0_4)
                                                  __cs_mutex_lock(&ma, 2);
tthread2_0_4:
                                                  ...
                                                  {
                                                            __CPROVER_set_field(&data2, "dr_write", 1);
                                                  }
IF(2,4,tthread2_0_5)
                                                  if (((4 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&data2, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  data2 -= 6;
tthread2_0_5:
IF(2,5,tthread2_0_6)
...
tmain_4:
IF(0,4,tmain_5)
                                                  if (((4 == __cs_pc[0]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&data1, "dr_write") || __CPROVER_get_field(&data2, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_main___cs_tmp_if_cond_0 = (data1 == 16) && (data2 == 5);
