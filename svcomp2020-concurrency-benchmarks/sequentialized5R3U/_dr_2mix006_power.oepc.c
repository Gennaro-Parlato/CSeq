 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/mix006_power.oepc.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {8, 4, 5, 5};
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_create(&__cs_nondet_main_t153, 0, P0_0, 0, 1);
                                                  static __cs_t __cs_nondet_main_t154;
tmain_1:
IF(0,1,tmain_2)
                                                  __cs_create(&__cs_nondet_main_t154, 0, P1_0, 0, 2);
                                                  static __cs_t __cs_nondet_main_t155;
tmain_2:
IF(0,2,tmain_3)
                                                  __cs_create(&__cs_nondet_main_t155, 0, P2_0, 0, 3);
tmain_3:
IF(0,3,tmain_4)
                                                  ;
