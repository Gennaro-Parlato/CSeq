 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/sigma.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[4] = {23, 1, 1, 1};
...
tmain_7:
IF(0,7,tmain_8)
                                                  if (((7 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
...
tmain_14:
IF(0,14,tmain_15)
                                                  if (((14 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(__cs_nondet_main_tid < SIGMA));
                                                  __exit_loop_2:
...
tmain_16:
IF(0,16,tmain_17)
                                                            if (((16 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
...
tmain_18:
IF(0,18,tmain_19)
                                                            if (((18 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
...
tmain_20:
IF(0,20,tmain_21)
                                                            if (((20 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&array[__cs_nondet_main_tid], "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_main_sum += array[__cs_nondet_main_tid];
                                                  }
                                                  ;
...
tmain_21:
IF(0,21,tmain_22)
                                                  if (((21 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(__cs_nondet_main_tid < SIGMA));
                                                  __exit_loop_3:
...
tmain_22:
IF(0,22,tmain_23)
                                                  if (((22 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&SIGMA, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
