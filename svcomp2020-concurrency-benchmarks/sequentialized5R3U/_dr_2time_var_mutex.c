 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/time_var_mutex.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {6, 9, 5};
                                        ...
                                        {
IF(1,0,tallocator_0_1)
                                                  __cs_mutex_lock(&m_inode, 1);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_allocator___cs_tmp_if_cond_0;
tallocator_0_1:
IF(1,1,tallocator_0_2)
                                                  if (((1 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&inode, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_allocator___cs_tmp_if_cond_0 = inode == 0;
                                                  if (__cs_nondet_allocator___cs_tmp_if_cond_0)
                                                            {
tallocator_0_2:
IF(1,2,tallocator_0_3)
                                                            __cs_mutex_lock(&m_busy, 1);
tallocator_0_3:
                                                            if (((3 == __cs_pc_cs[1]) & __cs_dataraceDetectionStarted) & (!__cs_dataraceSecondThread))
                                                            {
                                                                      __CPROVER_set_field(&busy, "dr_write", 1);
                                                            }
IF(1,3,tallocator_0_4)
                                                            if (((3 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&busy, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            busy = 1;
tallocator_0_4:
IF(1,4,tallocator_0_5)
                                                            __cs_mutex_unlock(&m_busy, 1);
tallocator_0_5:
                                                            if (((5 == __cs_pc_cs[1]) & __cs_dataraceDetectionStarted) & (!__cs_dataraceSecondThread))
                                                            {
                                                                      __CPROVER_set_field(&inode, "dr_write", 1);
                                                            }
IF(1,5,tallocator_0_6)
                                                            if (((5 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&inode, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            inode = 1;
                                                  }
...
tallocator_0_6:
                                                  ...
                                                  {
                                                            __CPROVER_set_field(&block, "dr_write", 1);
                                                  }
IF(1,6,tallocator_0_7)
                                                  if (((6 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&block, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  block = 1;
                                                  ;
                                                  ;
...
tallocator_0_7:
IF(1,7,tallocator_0_8)
                                                  if (((7 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&block, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_allocator___cs_tmp_if_cond_1 = !(block == 1);
                                                  if (__cs_nondet_allocator___cs_tmp_if_cond_1)
                                                            {
                                                            __CPROVER_assume(0);
                                                  }
                                                  ;
tallocator_0_8:
IF(1,8,tallocator_0_9)
                                                  __cs_mutex_unlock(&m_inode, 1);
...
tallocator_0_9: 
                                        ...
                                        {
IF(2,0,tde_allocator_0_1)
                                                  __cs_mutex_lock(&m_busy, 2);
                                                  ;
                                                  ;
                                                  static _Bool __cs_nondet_de_allocator___cs_tmp_if_cond_2;
tde_allocator_0_1:
IF(2,1,tde_allocator_0_2)
                                                  if (((1 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&busy, "dr_write"))
                                                            __cs_dataraceNotDetected = 0;
                                                  __cs_nondet_de_allocator___cs_tmp_if_cond_2 = busy == 0;
                                                  if (__cs_nondet_de_allocator___cs_tmp_if_cond_2)
                                                            {
tde_allocator_0_2:
...
IF(2,2,tde_allocator_0_3)
                                                            if (((2 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&block, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            block = 0;
                                                            ;
                                                            ;
...
tde_allocator_0_3:
IF(2,3,tde_allocator_0_4)
                                                            if (((3 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&block, "dr_write"))
                                                                      __cs_dataraceNotDetected = 0;
                                                            __cs_nondet_de_allocator___cs_tmp_if_cond_3 = !(block == 0);
                                                            if (__cs_nondet_de_allocator___cs_tmp_if_cond_3)
                                                                                {
                                                                      __CPROVER_assume(0);
                                                            }
                                                            ;
                                                  ...
                                                  ;
tde_allocator_0_4:
IF(2,4,tde_allocator_0_5)
                                                  __cs_mutex_unlock(&m_busy, 2);
...
IF(0,0,tmain_1)
                                                  ...
                                                  __cs_create(&__cs_nondet_main_t1, 0, allocator_0, 0, 1);
tmain_1:
IF(0,1,tmain_2)
                                                  __cs_create(&__cs_nondet_main_t2, 0, de_allocator_0, 0, 2);
tmain_2:
IF(0,2,tmain_3)
...
/* de_allocator_0 */
                                                  ...
                                                  if (__cs_dataraceContinue & __cs_active_thread[2])
                                                  {
                                                            ...
                                                            if (__cs_dr_ts == 2)
                                                                      __cs_dataraceDetectionStarted = 1;
                                                            de_allocator_0(__cs_threadargs[2]);
