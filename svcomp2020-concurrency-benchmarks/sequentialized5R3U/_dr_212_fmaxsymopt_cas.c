 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/12_fmaxsymopt_cas.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {4, 13, 13, 13};
...
tthr1_0_5:
IF(1,5,tthr1_0_6)
                                                                      if (((5 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&max, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
...
tthr1_1_5:
IF(2,5,tthr1_1_6)
                                                                      if (((5 == __cs_pc[2]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&max, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_findMax_1_c = max;
                                                                      ;
                                                                      ;
...
tthr1_2_5:
IF(3,5,tthr1_2_6)
                                                                      if (((5 == __cs_pc[3]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&max, "dr_write"))
                                                                                __cs_dataraceNotDetected = 0;
                                                                      __cs_nondet_findMax_1_c = max;
                                                                      ;
                                                                      ;
