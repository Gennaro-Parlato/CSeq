 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/gcd-2.i, --rounds 5, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B; 
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {5, 8, 8};
...
tdec_b_0_7:
IF(2,7,tdec_b_0_8)
                                                  if (((7 == __cs_pc[2]) & __cs_dataraceSecondThread) & (__CPROVER_get_field(&a, "dr_write") || __CPROVER_get_field(&b, "dr_write")))
                                                            __cs_dataraceNotDetected = 0;
                                                  __CPROVER_assume(!(a != b));
                                                  __exit_loop_2:
