 ...
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/bigshot_s.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
IF(2,4,tmain_thread_5)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&v, "dr_write"))), (!v) || (v[0] == 'B')));
                                        goto __exit_main;
                                                ;
                                        __exit_main:
