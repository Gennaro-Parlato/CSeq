 ...
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/fib_bench_longer-2.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
IF(0,4,tt1_0_5)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_t1_k, "dr_write"))), !(__cs_nondet_t1_k < 6)));
                                        __exit_loop_1:
...
IF(1,4,tt2_0_5)
                                        ...
                                        __CPROVER_assume(((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_t2_k, "dr_write"))), !(__cs_nondet_t2_k < 6)));
                                        __exit_loop_2:
