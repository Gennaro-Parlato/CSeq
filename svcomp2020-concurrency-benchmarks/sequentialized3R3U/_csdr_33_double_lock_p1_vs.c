 ...
 * 
 *  instance version    {"thr1_0": [[1, 25]], "thr2_0": [[1, 9]], "thr2_1": [[1, 9]], "thr2_2": [[1, 9]], "main": [[1, 5]]}
 *
 *  2021-06-28 16:46:26
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/33_double_lock_p1_vs.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[5] = {25, 9, 9, 9, 5};
...
IF(0,4,tthr1_0_5)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thr1___cs_tmp_if_cond_1, "dr_write", 1), ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thr1___cs_tmp_if_cond_1, "dr_write_noatomic", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thr1___cs_tmp_if_cond_1, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&count, "dr_write"))), __cs_nondet_thr1___cs_tmp_if_cond_1 = !(count == 0);
