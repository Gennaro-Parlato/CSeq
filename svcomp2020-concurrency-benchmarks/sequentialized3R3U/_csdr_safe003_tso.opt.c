 ...
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/safe003_tso.opt.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
IF(3,0,tmain_thread_1)
                                        ...
                                        static __cs_t __cs_nondet_main_t1870;
                                        __cs_create(&__cs_nondet_main_t1870, 0, P0_0, 0, 0);
                                        static __cs_t __cs_nondet_main_t1871;
tmain_thread_1:
IF(3,1,tmain_thread_2)
                                        __cs_create(&__cs_nondet_main_t1871, 0, P1_0, 0, 1);
                                        static __cs_t __cs_nondet_main_t1872;
tmain_thread_2:
IF(3,2,tmain_thread_3)
                                        __cs_create(&__cs_nondet_main_t1872, 0, P2_0, 0, 2);
tmain_thread_3:
