 ...
 * 
 *  instance version    {"thr1_0": [[1, 6]], "thr1_1": [[1, 6]], "thr1_2": [[1, 6]], "main": [[1, 4]]}
 *
 *  2021-06-28 16:46:09
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-ext/13_unverif.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[4] = {6, 6, 6, 4};
...
IF(0,4,tthr1_0_5)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thr1___cs_tmp_if_cond_1, "dr_write", 1), ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thr1___cs_tmp_if_cond_1, "dr_write_noatomic", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thr1___cs_tmp_if_cond_1, "dr_write"))), ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&s, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thr1_l, "dr_write")))), __cs_nondet_thr1___cs_tmp_if_cond_1 = !(s == __cs_nondet_thr1_l);
