 ...
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/thin001_tso.oepc.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
IF(3,0,tmain_thread_1)
                                        ...
                                        static __cs_t __cs_nondet_main_t2699;
                                        __cs_create(&__cs_nondet_main_t2699, 0, P0_0, 0, 0);
                                        static __cs_t __cs_nondet_main_t2700;
tmain_thread_1:
IF(3,1,tmain_thread_2)
                                        __cs_create(&__cs_nondet_main_t2700, 0, P1_0, 0, 1);
                                        static __cs_t __cs_nondet_main_t2701;
tmain_thread_2:
IF(3,2,tmain_thread_3)
                                        __cs_create(&__cs_nondet_main_t2701, 0, P2_0, 0, 2);
tmain_thread_3:
