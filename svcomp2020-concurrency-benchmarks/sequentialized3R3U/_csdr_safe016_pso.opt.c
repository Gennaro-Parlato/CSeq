 ...
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/safe016_pso.opt.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
IF(4,0,tmain_thread_1)
                                        ...
                                        static __cs_t __cs_nondet_main_t2157;
                                        __cs_create(&__cs_nondet_main_t2157, 0, P0_0, 0, 0);
                                        static __cs_t __cs_nondet_main_t2158;
tmain_thread_1:
IF(4,1,tmain_thread_2)
                                        __cs_create(&__cs_nondet_main_t2158, 0, P1_0, 0, 1);
                                        static __cs_t __cs_nondet_main_t2159;
tmain_thread_2:
IF(4,2,tmain_thread_3)
                                        __cs_create(&__cs_nondet_main_t2159, 0, P2_0, 0, 2);
                                        static __cs_t __cs_nondet_main_t2160;
tmain_thread_3:
IF(4,3,tmain_thread_4)
                                        __cs_create(&__cs_nondet_main_t2160, 0, P3_0, 0, 3);
tmain_thread_4:
