 ...
 * 
 *  instance version    {"allocator_0": [[1, 10]], "de_allocator_0": [[1, 6]], "main": [[1, 6]]}
 *
 *  2021-06-28 16:45:04
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/time_var_mutex.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 6, 6};
                                        ...
                                        *__cs_cond_to_broadcast = 1;
                                        ...
                                        __cs_mutex_t m_busy;
                                        void *allocator_0(void *__cs_param_allocator__)
                                        {
IF(0,0,tallocator_0_1)
                                        ...
                                        ;
                                                ;
                                        static _Bool __cs_nondet_allocator___cs_tmp_if_cond_0;
tallocator_0_1:
IF(0,1,tallocator_0_2)
                                                __cs_dataraceActiveVP1 = 1 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 1 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_allocator___cs_tmp_if_cond_0, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_allocator___cs_tmp_if_cond_0, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&inode, "dr_write"))), __cs_nondet_allocator___cs_tmp_if_cond_0 = inode == 0;
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_allocator___cs_tmp_if_cond_0, "dr_write"))), __cs_nondet_allocator___cs_tmp_if_cond_0)
                                                {
tallocator_0_2:
...
IF(0,6,tallocator_0_7)
                                        ...
                                        ;
                                                ;
                                        static _Bool __cs_nondet_allocator___cs_tmp_if_cond_1;
tallocator_0_7:
IF(0,7,tallocator_0_8)
                                                __cs_dataraceActiveVP1 = 7 == (__cs_pc_cs[0] - 1);
                                        __cs_dataraceActiveVP2 = 7 == __cs_pc[0];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_allocator___cs_tmp_if_cond_1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_allocator___cs_tmp_if_cond_1, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&block, "dr_write"))), __cs_nondet_allocator___cs_tmp_if_cond_1 = !(block == 1);
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_allocator___cs_tmp_if_cond_1, "dr_write"))), __cs_nondet_allocator___cs_tmp_if_cond_1)
                                                {
tallocator_0_8:
...
tallocator_0_10: 
                                        ...
                                        void *de_allocator_0(void *__cs_param_de_allocator__)
                                        {
IF(1,0,tde_allocator_0_1)
                                        ...
                                        ;
                                                ;
                                        static _Bool __cs_nondet_de_allocator___cs_tmp_if_cond_2;
tde_allocator_0_1:
IF(1,1,tde_allocator_0_2)
                                                __cs_dataraceActiveVP1 = 1 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 1 == __cs_pc[1];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_de_allocator___cs_tmp_if_cond_2, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_de_allocator___cs_tmp_if_cond_2, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&busy, "dr_write"))), __cs_nondet_de_allocator___cs_tmp_if_cond_2 = busy == 0;
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_de_allocator___cs_tmp_if_cond_2, "dr_write"))), __cs_nondet_de_allocator___cs_tmp_if_cond_2)
                                                {
tde_allocator_0_2:
IF(1,2,tde_allocator_0_3)
                                        ...
                                        ;
                                                        ;
                                        static _Bool __cs_nondet_de_allocator___cs_tmp_if_cond_3;
tde_allocator_0_3:
IF(1,3,tde_allocator_0_4)
                                                        __cs_dataraceActiveVP1 = 3 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 3 == __cs_pc[1];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_de_allocator___cs_tmp_if_cond_3, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_de_allocator___cs_tmp_if_cond_3, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&block, "dr_write"))), __cs_nondet_de_allocator___cs_tmp_if_cond_3 = !(block == 0);
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_de_allocator___cs_tmp_if_cond_3, "dr_write"))), __cs_nondet_de_allocator___cs_tmp_if_cond_3)
                                                        {
tde_allocator_0_4:
...
IF(2,0,tmain_thread_1)
                                        ...
                                        __cs_create(&__cs_nondet_main_t1, 0, allocator_0, 0, 0);
tmain_thread_1:
IF(2,1,tmain_thread_2)
                                        __cs_create(&__cs_nondet_main_t2, 0, de_allocator_0, 0, 1);
tmain_thread_2:
