 ...
 * 
 *  instance version    {"thread1_0": [[1, 3]], "thread2_0": [[1, 3]], "thread3_0": [[1, 4]], "main": [[1, 6]]}
 *
 *  2021-06-28 16:44:45
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/lazy01.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[4] = {3, 3, 4, 6};
...
IF(2,1,tthread3_0_2)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thread3___cs_tmp_if_cond_0, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thread3___cs_tmp_if_cond_0, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data, "dr_write"))), __cs_nondet_thread3___cs_tmp_if_cond_0 = data >= 3;
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thread3___cs_tmp_if_cond_0, "dr_write"))), __cs_nondet_thread3___cs_tmp_if_cond_0)
                                                {
tthread3_0_2:
IF(2,2,tthread3_0_3)
                                        __CPROVER_assume(0);
