 ...
 * 
 *  instance version    {"thr1_0": [[1, 7]], "thr2_0": [[1, 7]], "main": [[1, 4]]}
 *
 *  2021-06-28 16:45:00
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-atomic/peterson.i, --rounds 3, --unwind 3, --seq , --dr , --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {7, 7, 4};
...
IF(1,4,tthr2_0_5)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__cs_nondet_thr2___cs_tmp_if_cond_1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__cs_nondet_thr2___cs_tmp_if_cond_1, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&x, "dr_write"))), __cs_nondet_thr2___cs_tmp_if_cond_1 = !(x >= 1);
