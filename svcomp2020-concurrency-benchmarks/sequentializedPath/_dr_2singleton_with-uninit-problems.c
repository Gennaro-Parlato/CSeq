 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread/singleton_with-uninit-problems.i, --rounds 3, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
