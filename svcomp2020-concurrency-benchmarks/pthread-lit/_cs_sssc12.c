 ...
 * 
 *  instance version    {"thr_0": [[1, 11]], "thr_1": [[1, 11]], "main": [[1, 3]]}
 *
 *  2021-07-01 14:59:55
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-lit/sssc12.c, --rounds 2, --unwind 2, --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {11, 11, 3};
...
tthr_0_6:
IF(0,6,tthr_0_7)
                                        assert((0 <= __cs_local_thr_c) && (__cs_local_thr_c < len));
tthr_0_7:
IF(0,7,tthr_0_8)
