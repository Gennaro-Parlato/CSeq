 ...
 *
 *  params:
 *    -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-lit/sssc12_variant.c, --rounds 3, --unwind 3, --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        *__cs_cond_to_broadcast = 1;
                                        ...
                                        {
                                        static int __cs_local_thr_c;
                                        static int __cs_local_thr_end;
IF(0,0,tthr_0_1)
                                        __cs_local_thr_c = 0;
                                        __cs_local_thr_end = 0;
                                                {
tthr_0_1:
IF(0,1,tthr_0_2)
                                        ;
                                        ...
                                        ;
                                                ;
                                        static _Bool __cs_local_thr___cs_tmp_if_cond_0;
tthr_0_2:
IF(0,2,tthr_0_3)
                                        __cs_local_thr___cs_tmp_if_cond_0 = (next + 10) <= len;
                                        if (__cs_local_thr___cs_tmp_if_cond_0)
                                                {
tthr_0_3:
IF(0,3,tthr_0_4)
                                        __cs_local_thr_c = next;
tthr_0_4:
IF(0,4,tthr_0_5)
                                        next = (__cs_local_thr_end = next + 10);
                                                }
...
IF(0,5,tthr_0_6)
                                        ...
                                        ;
                                        if (!(__cs_local_thr_c < __cs_local_thr_end))
                                                {
                                        goto __exit_loop_1;
                                                        ;
                                                }
...
tthr_0_6:
IF(0,6,tthr_0_7)
                                        data[__cs_local_thr_c] = 0;
tthr_0_7:
IF(0,7,tthr_0_8)
                                        data[__cs_local_thr_c] = 1;
tthr_0_8:
IF(0,8,tthr_0_9)
                                        assert(data[__cs_local_thr_c] == 1);
                                        __cs_local_thr_c = __cs_local_thr_c + 1;
                                                }
                                        ;
                                        if (!(__cs_local_thr_c < __cs_local_thr_end))
                                                {
...
tthr_0_15:
IF(0,15,tthr_0_16)
                                        __CPROVER_assume(!(__cs_local_thr_c < __cs_local_thr_end));
                                        __exit_loop_1:
...
IF(3,0,tmain_thread_1)
                                        ...
                                        data = __cs_safe_malloc((sizeof(int)) * len);
                                                {
                                        __cs_create(&__cs_local_main_t, 0, thr_0, 0, 0);
                                                }
                                        ;
                                                {
tmain_thread_1:
IF(3,1,tmain_thread_2)
                                        __cs_create(&__cs_local_main_t, 0, thr_1, 0, 1);
                                                }
                                        ;
                                                {
tmain_thread_2:
IF(3,2,tmain_thread_3)
                                        __cs_create(&__cs_local_main_t, 0, thr_2, 0, 2);
                                                }
                                        ;
tmain_thread_3:
