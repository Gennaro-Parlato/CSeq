 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/mix008_pso.opt.i, --rounds 2, --unwind 4, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
