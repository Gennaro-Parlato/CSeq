 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/mix043_rmo.opt.i, --rounds 2, --unwind 4, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
