 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/mix021_power.oepc.i, --rounds 2, --unwind 4, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
