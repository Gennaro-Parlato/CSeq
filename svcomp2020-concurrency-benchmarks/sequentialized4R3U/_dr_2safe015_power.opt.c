 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/safe015_power.opt.i, --rounds 4, --unwind 3, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
