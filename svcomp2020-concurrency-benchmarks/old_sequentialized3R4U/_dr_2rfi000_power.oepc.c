 ...
 *
 *  params:
 *    -l datarace, -i /home/salvatore/ShadowMemory/svcomp2020-concurrency-benchmarks/pthread-wmm/rfi000_power.oepc.i, --rounds 3, --unwind 4, --local-vars 2, --seq , --svcomp , --debug , --paths , 
 *
 */
