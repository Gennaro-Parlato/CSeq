...
# such that CSeq-master folder will be the shared folder among EC2 instances:

#git clone https://github.com/Gennaro-Parlato/CSeq.git
su - aldo -c "unzip CSeq-master.zip"
...
echo "master slots=1" | sudo tee -a /home/aldo/CSeq-master/VeriSmart/nodes
echo "slave1 slots=1" | sudo tee -a /home/aldo/CSeq-master/VeriSmart/nodes
echo "slave2 slots=1" | sudo tee -a /home/aldo/CSeq-master/VeriSmart/nodes
echo "slave3 slots=1" | sudo tee -a /home/aldo/CSeq-master/VeriSmart/nodes
echo "slave4 slots=1" | sudo tee -a /home/aldo/CSeq-master/VeriSmart/nodes

#master declares that will share the project folder with slaves:
echo "/home/aldo/CSeq-master/VeriSmart *(rw,sync,no_root_squash,no_subtree_check)" | sudo tee -a /etc/exports
