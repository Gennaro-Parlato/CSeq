 ...
 * 
 *  instance version    {"thread1_0": [[1, 1]], "thread2_0": [[1, 3]], "thread3_0": [[1, 1]], "main": [[1, 1]]}
 *
 *  2022-07-21 10:37:16
 *
 *  params:
 *    --vs , -i examples/sample_ass.c, --dr , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[4] = {1, 3, 2, 7};
...
IF(0,0,tthread1_0_1)
                                        ...
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&data, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data, "dr_write"))), data++;
                                        __exit_thread1:
...
tthread1_0_1: 
                                        ...
                                        {
                                        static int *__dr_nondet_thread2_x;
                                        static int *__dr_nondet_thread2_b;
                                        static int **__dr_nondet_thread2_a;
                                        static int __dr_nondet_thread2_y;
IF(1,0,tthread2_0_1)
                                                __cs_dataraceActiveVP1 = 0 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 0 == __cs_pc[1];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_thread2_y, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_thread2_y, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data, "dr_write"))), __dr_nondet_thread2_y = data;
tthread2_0_1:
IF(1,1,tthread2_0_2)
                                                __cs_dataraceActiveVP1 = 1 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 1 == __cs_pc[1];
                                        (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_thread2_x, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(__dr_nondet_thread2_x, "dr_write"))), ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&(*__dr_nondet_thread2_x), "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&(*__dr_nondet_thread2_x), "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data, "dr_write"))), *__dr_nondet_thread2_x = data;
tthread2_0_2:
IF(1,2,tthread2_0_3)
                                                __cs_dataraceActiveVP1 = 2 == (__cs_pc_cs[1] - 1);
                                        __cs_dataraceActiveVP2 = 2 == __cs_pc[1];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_thread2_x, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_thread2_x, "dr_write"))), __dr_nondet_thread2_x = &S.ptop;
                                        __exit_thread2:
...
IF(2,0,tthread3_0_1)
                                        ...
                                        ;
                                                ;
                                        static _Bool __dr_nondet_thread3___cs_tmp_if_cond_0;
tthread3_0_1:
IF(2,1,tthread3_0_2)
                                                __cs_dataraceActiveVP1 = 1 == (__cs_pc_cs[2] - 1);
                                        __cs_dataraceActiveVP2 = 1 == __cs_pc[2];
                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&__dr_nondet_thread3___cs_tmp_if_cond_0, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_thread3___cs_tmp_if_cond_0, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&data, "dr_write"))), __dr_nondet_thread3___cs_tmp_if_cond_0 = data >= 3;
                                        if ((__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&__dr_nondet_thread3___cs_tmp_if_cond_0, "dr_write"))), __dr_nondet_thread3___cs_tmp_if_cond_0)
                                                {
                                        __CPROVER_assume(0);
                                        ;
                                                        ;
...
IF(3,3,tmain_thread_4)
                                        __cs_create(&__dr_nondet_main_t3, 0, thread3_0, 0, 2);
tmain_thread_4:
