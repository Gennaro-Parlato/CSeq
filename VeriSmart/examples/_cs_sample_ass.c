 ...
 * 
 *  instance version    {"thread1_0": [[1, 1]], "thread2_0": [[1, 5]], "thread3_0": [[1, 3]], "main": [[1, 6]]}
 *
 *  2021-04-01 17:17:57
 *
 *  params:
 *    -i examples/sample_ass.c, --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[4] = {1, 5, 3, 6};
...
tthread1_0_1: 
                                        ...
                                        {
                                        static int *__cs_local_thread2_x;
IF(1,0,tthread2_0_1)
                                        __cs_init_scalar(&__cs_local_thread2_x, sizeof(int *));
                                        static int **__cs_local_thread2_a;
                                        ;
                                                ;
tthread2_0_1:
IF(1,1,tthread2_0_2)
                                        *__cs_local_thread2_x = 1;
                                        static int __cs_retval_foo_1;
                                                {
                                        static int __cs_param_foo_1_x;
                                        __cs_param_foo_1_x = 3;
                                        __cs_retval_foo_1 = __cs_param_foo_1_x + 5;
                                        goto __exit_foo_1;
                                                        ;
                                        __exit_foo_1:
...
tthread2_0_2:
IF(1,2,tthread2_0_3)
                                        data = __cs_retval_foo_1 + 7;
tthread2_0_3:
IF(1,3,tthread2_0_4)
                                        __cs_local_thread2_a[1][1] = 7 + __cs_local_thread2_x;
tthread2_0_4:
IF(1,4,tthread2_0_5)
                                        *(__cs_local_thread2_a + 3) = __cs_local_thread2_x;
                                        sizeof(int);
                                        __exit_thread2:
...
IF(3,0,tmain_thread_1)
                                        ...
                                        ;
                                                ;
                                        __cs_create(&__cs_local_main_t1, 0, thread1_0, 0, 0);
tmain_thread_1:
IF(3,1,tmain_thread_2)
                                        __cs_create(&__cs_local_main_t2, 0, thread2_0, 0, 1);
tmain_thread_2:
IF(3,2,tmain_thread_3)
                                        __cs_create(&__cs_local_main_t3, 0, thread3_0, 0, 2);
tmain_thread_3:
