 ...
 * 
 *  instance version    {"thread1_0": [[1, 1]], "thread2_0": [[1, 3]], "thread3_0": [[1, 3]], "main": [[1, 6]]}
 *
 *  2021-04-20 10:23:24
 *
 *  params:
 *    -i examples/sample_struct.c, --debug , --dr , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[4] = {1, 3, 3, 6};
...
IF(0,0,tthread1_0_1)
                                                if (((0 == __cs_pc[0]) & __cs_dataraceSecondThread) & __CPROVER_get_field(&data, "dr_write"))
...
IF(1,2,tthread2_0_3)
                                                if (((2 == __cs_pc[1]) & __cs_dataraceSecondThread) & __CPROVER_get_field(__cs_nondet_thread2_p, "dr_write"))
                                                        __cs_dataraceNotDetected = 0;
...
/* thread1_0 */
                                        ...
                                        if (__cs_dataraceSecondThread & (__cs_tmp_t0_r0 > __cs_pc[0]))
