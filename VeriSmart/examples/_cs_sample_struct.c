 ...
 * 
 *  instance version    {"thread1_0": [[1, 1]], "thread2_0": [[1, 4]], "thread3_0": [[1, 3]], "main": [[1, 6]]}
 *
 *  2021-04-20 10:23:16
 *
 *  params:
 *    -i examples/sample_struct.c, --debug , 
 *
 */
...
#define SMSIZE 5
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[4] = {1, 4, 3, 6};
...
tthread1_0_1: 
                                        ...
                                        {
                                        static luogo __cs_local_thread2_l;
IF(1,0,tthread2_0_1)
                                        __cs_init_scalar(&__cs_local_thread2_l, sizeof(struct anonstruct_0));
                                        static luogo *__cs_local_thread2_p;
tthread2_0_1:
IF(1,1,tthread2_0_2)
                                        __cs_init_scalar(&__cs_local_thread2_p, sizeof(struct anonstruct_0 *));
                                        __cs_local_thread2_l.x = 10;
tthread2_0_2:
IF(1,2,tthread2_0_3)
                                        __cs_local_thread2_p = (luogo) __cs_safe_malloc(sizeof(luogo));
tthread2_0_3:
IF(1,3,tthread2_0_4)
                                        (*__cs_local_thread2_p).x = 100;
                                        __exit_thread2:
