...
// added stuff from the original version
...
// end added stuff from the original version
...
static void server_stats(ADD_STAT add_stats, conn *c) {
...
#endif
#ifndef WIN32
    struct rusage xusage;
    getrusage(RUSAGE_SELF, &xusage);
#endif /* !WIN32 */
    ...
    append_stat("rusage_user", add_stats, c, "%ld.%06ld",
                (long)xusage.ru_utime.tv_sec,
                (long)xusage.ru_utime.tv_usec);
    append_stat("rusage_system", add_stats, c, "%ld.%06ld",
                (long)xusage.ru_stime.tv_sec,
                (long)xusage.ru_stime.tv_usec);
#endif /* !WIN32 */
...
static void __CSEQ_atomic_clock_handler(const int fd, const short which, void *arg) {
    ...
    evtimer_set(&clockevent, __CSEQ_atomic_clock_handler, 0);
...
static void __CSEQ_atomic_sig_handler(const int sig) {
    printf("Signal handled: %s.\n", strsignal(sig));
    exit(EXIT_SUCCESS);
}

static void __CSEQ_atomic_sighup_handler(const int sig) {
    settings.sig_hup = true;
}

static void __CSEQ_atomic_sig_usrhandler(const int sig) {
...
static int __CSEQ_atomic__mc_meta_save_cb(const char *tag, void *ctx, void *data) {
...
static int __CSEQ_atomic__mc_meta_load_cb(const char *tag, void *ctx, void *data) {
    struct _mc_meta_data *meta = (struct _mc_meta_data *)data;
    char *key;
    char *val;
    int reuse_mmap = 0;
...
*/
  char *opts[19];
  opts[R_MMAP_OLDBASE] = "mmap_oldbase";
  opts[R_MAXBYTES] = "maxbytes";
  opts[R_CHUNK_SIZE] = "chunk_size";
  opts[R_ITEM_SIZE_MAX] = "item_size_max";
  opts[R_SLAB_CHUNK_SIZE_MAX] = "slab_chunk_size_max";
  opts[R_SLAB_PAGE_SIZE] = "slab_page_size";
  opts[R_SLAB_CONFIG] = "slab_config";
  opts[R_USE_CAS] = "use_cas";
  opts[R_SLAB_REASSIGN] = "slab_reassign";
  opts[R_CURRENT_CAS] = "current_cas";
  opts[R_OLDEST_CAS] = "oldest_cas";
  opts[R_OLDEST_LIVE] = "oldest_live";
  opts[R_LOGGER_GID] = "logger_gid";
  opts[R_CURRENT_TIME] = "current_time";
  opts[R_STOP_TIME] = "stop_time";
  opts[R_PROCESS_STARTED] = "process_started";
  opts[R_HASHPOWER] = "hashpower";
...
*/
    ...
    char * subopts_tokens[100];
    subopts_tokens[MAXCONNS_FAST] = "maxconns_fast";
        subopts_tokens[HASHPOWER_INIT] = "hashpower";
        subopts_tokens[NO_HASHEXPAND] = "no_hashexpand";
        subopts_tokens[SLAB_REASSIGN] = "slab_reassign";
        subopts_tokens[SLAB_AUTOMOVE] = "slab_automove";
        subopts_tokens[SLAB_AUTOMOVE_RATIO] = "slab_automove_ratio";
        subopts_tokens[SLAB_AUTOMOVE_WINDOW] = "slab_automove_window";
        subopts_tokens[TAIL_REPAIR_TIME] = "tail_repair_time";
        subopts_tokens[HASH_ALGORITHM] = "hash_algorithm";
        subopts_tokens[LRU_CRAWLER] = "lru_crawler";
        subopts_tokens[LRU_CRAWLER_SLEEP] = "lru_crawler_sleep";
        subopts_tokens[LRU_CRAWLER_TOCRAWL] = "lru_crawler_tocrawl";
        subopts_tokens[LRU_MAINTAINER] = "lru_maintainer";
        subopts_tokens[HOT_LRU_PCT] = "hot_lru_pct";
        subopts_tokens[WARM_LRU_PCT] = "warm_lru_pct";
        subopts_tokens[HOT_MAX_FACTOR] = "hot_max_factor";
        subopts_tokens[WARM_MAX_FACTOR] = "warm_max_factor";
        subopts_tokens[TEMPORARY_TTL] = "temporary_ttl";
        subopts_tokens[IDLE_TIMEOUT] = "idle_timeout";
        subopts_tokens[WATCHER_LOGBUF_SIZE] = "watcher_logbuf_size";
        subopts_tokens[WORKER_LOGBUF_SIZE] = "worker_logbuf_size";
        subopts_tokens[SLAB_SIZES] = "slab_sizes";
        subopts_tokens[SLAB_CHUNK_MAX] = "slab_chunk_max";
        subopts_tokens[TRACK_SIZES] = "track_sizes";
        subopts_tokens[NO_INLINE_ASCII_RESP] = "no_inline_ascii_resp";
        subopts_tokens[MODERN] = "modern";
        subopts_tokens[NO_MODERN] = "no_modern";
        subopts_tokens[NO_CHUNKED_ITEMS] = "no_chunked_items";
        subopts_tokens[NO_SLAB_REASSIGN] = "no_slab_reassign";
        subopts_tokens[NO_SLAB_AUTOMOVE] = "no_slab_automove";
        subopts_tokens[NO_MAXCONNS_FAST] = "no_maxconns_fast";
        subopts_tokens[INLINE_ASCII_RESP] = "inline_ascii_resp";
        subopts_tokens[NO_LRU_CRAWLER] = "no_lru_crawler";
        subopts_tokens[NO_LRU_MAINTAINER] = "no_lru_maintainer";
        subopts_tokens[NO_DROP_PRIVILEGES] = "no_drop_privileges";
        subopts_tokens[DROP_PRIVILEGES] = "drop_privileges";
        //subopts_tokens[RESP_OBJ_MEM_LIMIT] = "resp_obj_mem_limit";
        //subopts_tokens[READ_BUF_MEM_LIMIT] = "read_buf_mem_limit";
#ifdef TLS
        subopts_tokens[SSL_CERT] = "ssl_chain_cert";
        subopts_tokens[SSL_KEY] = "ssl_key";
        subopts_tokens[SSL_VERIFY_MODE] = "ssl_verify_mode";
        subopts_tokens[SSL_KEYFORM] = "ssl_keyformat";
        subopts_tokens[SSL_CIPHERS] = "ssl_ciphers";
        subopts_tokens[SSL_CA_CERT] = "ssl_ca_cert";
        subopts_tokens[SSL_WBUF_SIZE] = "ssl_wbuf_size";
        subopts_tokens[SSL_SESSION_CACHE] = "ssl_session_cache";
#endif
#ifdef MEMCACHED_DEBUG
        subopts_tokens[RELAXED_PRIVILEGES] = "relaxed_privileges";
#endif
    ...
    signal(SIGINT, __CSEQ_atomic_sig_handler);
    signal(SIGTERM, __CSEQ_atomic_sig_handler);
    signal(SIGHUP, __CSEQ_atomic_sighup_handler);
    signal(SIGUSR1, __CSEQ_atomic_sig_usrhandler);
    ...
    if (memory_file != NULL) {
        ...
        prefill = true;
        restart_register("main", __CSEQ_atomic__mc_meta_load_cb, __CSEQ_atomic__mc_meta_save_cb, meta);
...
#endif
    __CSEQ_atomic_clock_handler(0, 0, 0);
