 ...
 * 
 *  instance version    {"thr1_0": [[4, 4]], "thr2_0": [[5, 5]], "main": [[1, 1]]}
 *
 *  2022-07-21 10:36:35
 *
 *  params:
...
IF(1,1,tthr2_0_2)
                                                        ...
                                                        ((__cs_dataraceActiveVP1 && __cs_dataraceDetectionStarted) && (!__cs_dataraceSecondThread)) && __CPROVER_set_field(&flag1, "dr_write", 1), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&flag1, "dr_write"))), (__cs_dataraceActiveVP2 && __cs_dataraceSecondThread) && (__cs_dataraceNotDetected = __cs_dataraceNotDetected && (!__CPROVER_get_field(&flag1, "dr_write"))), flag1 = flag1;
                                                        flag2 = flag2;
                                                        __CPROVER_assume(0);
                                                }
